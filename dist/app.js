...
Opal.modules["opal_hot_reloader/reactrb_patches"] = function(Opal) {
  var self = Opal.top, $scope = Opal, nil = Opal.nil, $breaker = Opal.breaker, $slice = Opal.slice, $klass = Opal.klass, $module = Opal.module;

  Opal.add_stubs(['$class_attribute', '$send', '$define_singleton_method', '$concat', '$push', '$alias_method', '$==', '$add_to_global_component_list', '$original_run_callback', '$remove_from_global_component_list', '$add', '$new', '$delete', '$each', '$to_proc']);
  return (function($base, $super) {
    function $ReactrbPatches(){};
    var self = $ReactrbPatches = $klass($base, $super, 'ReactrbPatches', $ReactrbPatches);

    var def = self.$$proto, $scope = self.$$scope, TMP_7;

    return (Opal.defs(self, '$patch!', TMP_7 = function() {
      var self = this;
      ...
      (function($base) {
        ...
        (function($base) {
          ...
          (function($base) {
            ...
            Opal.defn(self, '$define_callback', TMP_2 = function $$define_callback(callback_name) {
              var $a, $b, TMP_1, self = this, $iter = TMP_2.$$p, $yield = $iter || nil, attribute_name = nil;

              TMP_2.$$p = null;
              attribute_name = "_" + (callback_name) + "_callbacks";
              self.$class_attribute(attribute_name);
              self.$send("" + (attribute_name) + "=", []);
              return ($a = ($b = self).$define_singleton_method, $a.$$p = (TMP_1 = function($c_rest){var self = TMP_1.$$s || this, block, args, callbacks = nil;
              ...
              callbacks = [];
                ...
                return self.$send("" + (attribute_name) + "=", callbacks);}, TMP_1.$$s = self, TMP_1.$$arity = -1, TMP_1), $a).call($b, callback_name);
            }, TMP_2.$$arity = 1)
          })($scope.base)
        })($scope.base)
      })(Opal.Object);
      return (function($base) {
        ...
        (function($base) {
          ...
          self.$alias_method("original_run_callback", "run_callback");
          ...
          Opal.defn(self, '$run_callback', TMP_3 = function $$run_callback(name, $a_rest) {
            ...
            if (name['$==']("before_mount")) {
              (($scope.get('React')).$$scope.get('Component')).$add_to_global_component_list(self)};
            ($b = self).$original_run_callback.apply($b, [name].concat(Opal.to_a(args)));
            if (name['$==']("before_unmount")) {
              return (($scope.get('React')).$$scope.get('Component')).$remove_from_global_component_list(self)
              } else {
              return nil
            };
          }, TMP_3.$$arity = -2);
        ...
        (function($base) {
          ...
          Opal.defs(self, '$add_to_global_component_list', TMP_4 = function $$add_to_global_component_list(instance) {
            var $a, self = this;
            if (self.global_component_list == null) self.global_component_list = nil;

            return (((($a = self.global_component_list) !== false && $a !== nil && $a != null) ? $a : self.global_component_list = $scope.get('Set').$new())).$add(instance);
          }, TMP_4.$$arity = 1);

          Opal.defs(self, '$remove_from_global_component_list', TMP_5 = function $$remove_from_global_component_list(instance) {
            var self = this;
            if (self.global_component_list == null) self.global_component_list = nil;

            return self.global_component_list.$delete(instance);
          }, TMP_5.$$arity = 1);

          Opal.defs(self, '$force_update!', TMP_6 = function() {
            var $a, $b, $c, self = this;
            if (self.global_component_list == null) self.global_component_list = nil;

            return ($a = self.global_component_list, $a !== false && $a !== nil && $a != null ?($b = ($c = self.global_component_list).$each, $b.$$p = "force_update!".$to_proc(), $b).call($c) : $a);
          }, TMP_6.$$arity = 0);
        })($scope.base);
      })(Opal.Object);
    }, TMP_7.$$arity = 0), nil) && 'patch!'
  })($scope.base, null)
};
...
/* Generated by Opal 0.10.5 */
Opal.modules["opal_hot_reloader/css_reloader"] = function(Opal) {
  ...
  Opal.add_stubs(['$require', '$[]', '$puts', '$to_i', '$now', '$Native', '$each', '$==', '$rel', '$is_matching_stylesheet?', '$href', '$!~', '$href=', '$+', '$sub', '$-', '$length', '$index', '$basename']);
  self.$require("native");
  return (function($base, $super) {
    function $OpalHotReloader(){};
    var self = $OpalHotReloader = $klass($base, $super, 'OpalHotReloader', $OpalHotReloader);

    var def = self.$$proto, $scope = self.$$scope;

    return (function($base, $super) {
      function $CssReloader(){};
      var self = $CssReloader = $klass($base, $super, 'CssReloader', $CssReloader);

      var def = self.$$proto, $scope = self.$$scope, TMP_2, TMP_3;

      Opal.defn(self, '$reload', TMP_2 = function $$reload(reload_request, document) {
        var $a, $b, TMP_1, self = this, url = nil, to_append = nil, links = nil;

        url = reload_request['$[]']("url");
        self.$puts("Reloading CSS: " + (url));
        to_append = "t_hot_reload=" + ($scope.get('Time').$now().$to_i());
        links = self.$Native(document.getElementsByTagName("link"));
        return ($a = ($b = ($range(0, $rb_minus(links.$length(), 1), false))).$each, $a.$$p = (TMP_1 = function(i){var self = TMP_1.$$s || this, $c, $d, link = nil;
if (i == null) i = nil;
        link = links['$[]'](i);
          if ((($c = (($d = link.$rel()['$==']("stylesheet")) ? self['$is_matching_stylesheet?'](link.$href(), url) : link.$rel()['$==']("stylesheet"))) !== nil && $c != null && (!$c.$$is_boolean || $c == true))) {
            if ((($c = link.$href()['$!~'](/\?/)) !== nil && $c != null && (!$c.$$is_boolean || $c == true))) {
              return ($c = link, $c['$href=']($rb_plus($c.$href(), "?" + (to_append))))
            } else if ((($c = link.$href()['$!~'](/t_hot_reload/)) !== nil && $c != null && (!$c.$$is_boolean || $c == true))) {
              return ($c = link, $c['$href=']($rb_plus($c.$href(), "&" + (to_append))))
              } else {
              return (($c = [link.$href().$sub(/t_hot_reload=\d+/, to_append)]), $d = link, $d['$href='].apply($d, $c), $c[$c.length-1])
            }
            } else {
            return nil
      ...
      return (Opal.defn(self, '$is_matching_stylesheet?', TMP_3 = function(href, url) {
        var $a, self = this, url_base = nil, href_base = nil;

        if ((($a = href.$index(url)) !== nil && $a != null && (!$a.$$is_boolean || $a == true))) {
          return true
          } else {
          url_base = $scope.get('File').$basename(url).$sub(/\.s?css+/, "").$sub(/\.s?css+/, "");
          href_base = $scope.get('File').$basename(href).$sub(/\.self-?.*.css.+/, "");
          return url_base['$=='](href_base);
        };
      }, TMP_3.$$arity = 2), nil) && 'is_matching_stylesheet?';
    })($scope.base, null)
  })($scope.base, null);
};
...
/* Generated by Opal 0.10.5 */
Opal.modules["opal_hot_reloader"] = function(Opal) {
  var $a, $b, TMP_1, self = Opal.top, $scope = Opal, nil = Opal.nil, $breaker = Opal.breaker, $slice = Opal.slice, $gvars = Opal.gvars, $klass = Opal.klass;

  Opal.add_stubs(['$require', '$proc', '$eval', '$sub', '$==', '$puts', '$lambda', '$reload', '$[]', '$use_alert?', '$alert', '$parse', '$call', '$notify_error', '$new', '$connect_to_websocket', '$warn', '$create_framework_aware_server', '$patch!', '$force_update!', '$listen']);
  self.$require("opal_hot_reloader/reactrb_patches");
  self.$require("opal_hot_reloader/css_reloader");
  self.$require("opal-parser");
  self.$require("json");
  $gvars.eval_proc = ($a = ($b = self).$proc, $a.$$p = (TMP_1 = function(s){var self = TMP_1.$$s || this;
if (s == null) s = nil;
  return self.$eval(s)}, TMP_1.$$s = self, TMP_1.$$arity = 1, TMP_1), $a).call($b);
  return (function($base, $super) {
    function $OpalHotReloader(){};
    var self = $OpalHotReloader = $klass($base, $super, 'OpalHotReloader', $OpalHotReloader);

    var def = self.$$proto, $scope = self.$$scope, TMP_3, TMP_4, TMP_5, TMP_6, TMP_7, TMP_8, TMP_9, TMP_10, TMP_11, TMP_13;

    def.reload_post_callback = def.css_reloader = def.port = nil;
    Opal.defn(self, '$connect_to_websocket', TMP_3 = function $$connect_to_websocket(port) {
      var $a, $b, TMP_2, self = this, host = nil, ws_url = nil;

      host = (window.location.host).$sub(/:\d+/, "");
      if (host['$==']("")) {
        host = "127.0.0.1"};
      ws_url = "" + (host) + ":" + (port);
      self.$puts("Hot-Reloader connecting to " + (ws_url));
      
      ws = new WebSocket('ws://' + ws_url);
      // console.log(ws);
      ws.onmessage = ($a = ($b = self).$lambda, $a.$$p = (TMP_2 = function(e){var self = TMP_2.$$s || this;
if (e == null) e = nil;
      return self.$reload(e)}, TMP_2.$$s = self, TMP_2.$$arity = 1, TMP_2), $a).call($b)
    ;
    }, TMP_3.$$arity = 1);

    Opal.defn(self, '$notify_error', TMP_4 = function $$notify_error(reload_request) {
      var $a, self = this, msg = nil;
      if ($gvars["!"] == null) $gvars["!"] = nil;

      msg = "OpalHotReloader " + (reload_request['$[]']("filename")) + " RELOAD ERROR:\n\n" + ($gvars["!"]);
      self.$puts(msg);
      if ((($a = self['$use_alert?']()) !== nil && $a != null && (!$a.$$is_boolean || $a == true))) {
    ...
    (Opal.cvars['@@USE_ALERT'] = true);

    Opal.defs(self, '$alerts_on!', TMP_5 = function() {
      var self = this;

      return (Opal.cvars['@@USE_ALERT'] = true);
    }, TMP_5.$$arity = 0);

    Opal.defs(self, '$alerts_off!', TMP_6 = function() {
      var self = this;

      return (Opal.cvars['@@USE_ALERT'] = false);
    }, TMP_6.$$arity = 0);

    Opal.defn(self, '$use_alert?', TMP_7 = function() {
      var $a, self = this;

      return (($a = Opal.cvars['@@USE_ALERT']) == null ? nil : $a);
    }, TMP_7.$$arity = 0);

    Opal.defn(self, '$reload', TMP_8 = function $$reload(e) {
      var $a, self = this, reload_request = nil;
      if ($gvars.eval_proc == null) $gvars.eval_proc = nil;

      reload_request = $scope.get('JSON').$parse(e.data);
      if (reload_request['$[]']("type")['$==']("ruby")) {
        self.$puts("Reloading ruby " + (reload_request['$[]']("filename")));
        try {
          $gvars.eval_proc.$call(reload_request['$[]']("source_code"))
        } catch ($err) {
          if (Opal.rescue($err, [$scope.get('StandardError')])) {
            try {
              self.$notify_error(reload_request)
            } finally { Opal.pop_exception() }
          } else { throw $err; }
        };
        if ((($a = self.reload_post_callback) !== nil && $a != null && (!$a.$$is_boolean || $a == true))) {
          self.reload_post_callback.$call()
          } else {
          self.$puts("no reloading callback to call")
        };};
      if (reload_request['$[]']("type")['$==']("css")) {
        return self.css_reloader.$reload(reload_request, document)
        } else {
        return nil
      };
    }, TMP_8.$$arity = 1);

    Opal.defn(self, '$initialize', TMP_9 = function $$initialize(port) {
      var self = this, $iter = TMP_9.$$p, reload_post_callback = $iter || nil;
      ...
      TMP_9.$$p = null;
      self.port = port;
      self.reload_post_callback = reload_post_callback;
      return self.css_reloader = $scope.get('CssReloader').$new();
    }, TMP_9.$$arity = -1);

    Opal.defn(self, '$listen', TMP_10 = function $$listen() {
      var self = this;

      return self.$connect_to_websocket(self.port);
    }, TMP_10.$$arity = 0);

    Opal.defs(self, '$listen', TMP_11 = function $$listen(port, reactrb) {
      var $a, self = this;
      ...
      if ((($a = self.server) !== nil && $a != null && (!$a.$$is_boolean || $a == true))) {
        return nil};
      if (reactrb !== false && reactrb !== nil && reactrb != null) {
        self.$warn("OpalHotReloader.listen(" + (port) + "): reactrb flag is deprectated and will be removed in gem release 0.2. React will automatically be detected")};
      return self.$create_framework_aware_server(port);
    }, TMP_11.$$arity = -1);

    return (Opal.defs(self, '$create_framework_aware_server', TMP_13 = function $$create_framework_aware_server(port) {
      var $a, $b, TMP_12, self = this;
      if (self.server == null) self.server = nil;

      if ((($a = (Opal.Object.$$scope.React == null ? nil : 'constant')) !== nil && $a != null && (!$a.$$is_boolean || $a == true))) {
        $scope.get('ReactrbPatches')['$patch!']();
        self.server = ($a = ($b = $scope.get('OpalHotReloader')).$new, $a.$$p = (TMP_12 = function(){var self = TMP_12.$$s || this;

        return (($scope.get('React')).$$scope.get('Component'))['$force_update!']()}, TMP_12.$$s = self, TMP_12.$$arity = 0, TMP_12), $a).call($b, port);
        } else {
        self.$puts("No framework detected");
        self.server = $scope.get('OpalHotReloader').$new(port);
      };
      return self.server.$listen();
    }, TMP_13.$$arity = 1), nil) && 'create_framework_aware_server';
  })($scope.base, null);
};

/* Generated by Opal 0.10.5 */
Opal.modules["components/router/app_router"] = function(Opal) {
  var self = Opal.top, $scope = Opal, nil = Opal.nil, $breaker = Opal.breaker, $slice = Opal.slice, $klass = Opal.klass, $hash2 = Opal.hash2;

  Opal.add_stubs(['$history', '$route', '$DIV', '$Switch', '$Route', '$DocsPage']);
  return (function($base, $super) {
    function $AppRouter(){};
    var self = $AppRouter = $klass($base, $super, 'AppRouter', $AppRouter);

    var def = self.$$proto, $scope = self.$$scope, $a, $b, TMP_1;

    self.$history("browser");

    return ($a = ($b = self).$route, $a.$$p = (TMP_1 = function(){var self = TMP_1.$$s || this, $c, $d, TMP_2;

    return ($c = ($d = self).$DIV, $c.$$p = (TMP_2 = function(){var self = TMP_2.$$s || this, $e, $f, TMP_3;

      return ($e = ($f = self).$Switch, $e.$$p = (TMP_3 = function(){var self = TMP_3.$$s || this, $g, $h, TMP_4;
        ...
        self.$Route("/", $hash2(["exact", "mounts"], {"exact": true, "mounts": $scope.get('HomePage')}));
          ...
          return ($g = ($h = self).$Route, $g.$$p = (TMP_4 = function(m, l, h){var self = TMP_4.$$s || this;
if (m == null) m = nil;if (l == null) l = nil;if (h == null) h = nil;
          return self.$DocsPage($hash2(["match", "location", "history"], {"match": m, "location": l, "history": h}))}, TMP_4.$$s = self, TMP_4.$$arity = 3, TMP_4), $g).call($h, "/docs", $hash2(["exact"], {"exact": false}));}, TMP_3.$$s = self, TMP_3.$$arity = 0, TMP_3), $e).call($f)}, TMP_2.$$s = self, TMP_2.$$arity = 0, TMP_2), $c).call($d)}, TMP_1.$$s = self, TMP_1.$$arity = 0, TMP_1), $a).call($b);
...
/* Generated by Opal 0.10.5 */
Opal.modules["components/docs/docs_body"] = function(Opal) {
  var self = Opal.top, $scope = Opal, nil = Opal.nil, $breaker = Opal.breaker, $slice = Opal.slice;
...
Opal.modules["components/docs/docs_page"] = function(Opal) {
  ...
  Opal.add_stubs(['$before_mount', '$hide', '$render', '$puts', '$url', '$match', '$as_node', '$PageToc', '$history', '$params', '$location', '$PageBody', '$Route', '$PageLayout', '$loaded?', '$[]', '$sections']);
  return (function($base, $super) {
    function $DocsPage(){};
    ...
    return ($a = ($c = self).$render, $a.$$p = (TMP_2 = function(){var self = TMP_2.$$s || this, $d, $e, TMP_3, $f, TMP_4, $g, TMP_5, section_name = nil, displaytitle = nil, sidebar = nil, body = nil;

    self.$puts(self.$match().$url());
      section_name = "docs";
      displaytitle = "Hyperloop Documentation";
      sidebar = self.$PageToc($hash2(["history", "location", "section"], {"history": self.$params().$history(), "location": self.$params().$location(), "section": section_name})).$as_node();
      body = self.$PageBody($hash2(["section"], {"section": section_name})).$as_node();
      ...
      return self.$PageLayout($hash2(["sidebar_component", "body_component", "page_title", "section", "loaded"], {"sidebar_component": sidebar, "body_component": body, "page_title": displaytitle, "section": section_name, "loaded": $scope.get('SiteStore').$sections()['$[]'](section_name)['$loaded?']()}));}, TMP_2.$$s = self, TMP_2.$$arity = 0, TMP_2), $a).call($c, $scope.get('DIV'));
...
Opal.modules["components/home/home_page"] = function(Opal) {
  ...
  Opal.add_stubs(['$before_mount', '$hide', '$after_mount', '$on', '$[]', '$render', '$DIV', '$SidebarMenu', '$main_content', '$AppMenu', '$H1', '$SPAN', '$Link', '$I', '$H2', '$IMG', '$P', '$A', '$AppFooter']);
  return (function($base, $super) {
    function $HomePage(){};
    var self = $HomePage = $klass($base, $super, 'HomePage', $HomePage);

    var def = self.$$proto, $scope = self.$$scope, $a, $b, TMP_1, $c, TMP_2, $d, TMP_4, TMP_29;

    ($a = ($b = self).$before_mount, $a.$$p = (TMP_1 = function(){var self = TMP_1.$$s || this;

    return $scope.get('SidebarStore').$hide()}, TMP_1.$$s = self, TMP_1.$$arity = 0, TMP_1), $a).call($b);

    ($a = ($c = self).$after_mount, $a.$$p = (TMP_2 = function(){var self = TMP_2.$$s || this, $d, $e, TMP_3;

    return ($d = ($e = $scope.get('Element')['$[]'](".bm-overlay")).$on, $d.$$p = (TMP_3 = function(){var self = TMP_3.$$s || this;

      return $scope.get('SidebarStore').$hide()}, TMP_3.$$s = self, TMP_3.$$arity = 0, TMP_3), $d).call($e, "click")}, TMP_2.$$s = self, TMP_2.$$arity = 0, TMP_2), $a).call($c);

    ($a = ($d = self).$render, $a.$$p = (TMP_4 = function(){var self = TMP_4.$$s || this, $e, $f, TMP_5;

    return ($e = ($f = self).$DIV, $e.$$p = (TMP_5 = function(){var self = TMP_5.$$s || this, $g, $h, TMP_6;

      self.$SidebarMenu();
        return ($g = ($h = self).$DIV, $g.$$p = (TMP_6 = function(){var self = TMP_6.$$s || this;

        return self.$main_content()}, TMP_6.$$s = self, TMP_6.$$arity = 0, TMP_6), $g).call($h, $hash2(["class"], {"class": "page-wrap"}));}, TMP_5.$$s = self, TMP_5.$$arity = 0, TMP_5), $e).call($f, $hash2(["id", "class"], {"id": "example", "class": "index"}))}, TMP_4.$$s = self, TMP_4.$$arity = 0, TMP_4), $a).call($d);

    return (Opal.defn(self, '$main_content', TMP_29 = function $$main_content() {
      var $a, $b, TMP_7, self = this;

      ($a = ($b = self).$DIV, $a.$$p = (TMP_7 = function(){var self = TMP_7.$$s || this, $c, $d, TMP_8, $e, TMP_15;

      self.$AppMenu($hash2(["section"], {"section": "home"}));
        ($c = ($d = self).$DIV, $c.$$p = (TMP_8 = function(){var self = TMP_8.$$s || this, $e, $f, TMP_9;

        return ($e = ($f = self).$DIV, $e.$$p = (TMP_9 = function(){var self = TMP_9.$$s || this, $g, $h, TMP_10;

          return ($g = ($h = self).$DIV, $g.$$p = (TMP_10 = function(){var self = TMP_10.$$s || this, $i, $j, TMP_11;

            return ($i = ($j = self).$DIV, $i.$$p = (TMP_11 = function(){var self = TMP_11.$$s || this, $k, $l, TMP_12, $m, TMP_14;

              ($k = ($l = self).$H1, $k.$$p = (TMP_12 = function(){var self = TMP_12.$$s || this, $m, $n, TMP_13;

                return ($m = ($n = self).$SPAN, $m.$$p = (TMP_13 = function(){var self = TMP_13.$$s || this;

                  return "Hyperloop"}, TMP_13.$$s = self, TMP_13.$$arity = 0, TMP_13), $m).call($n, $hash2(["class"], {"class": "library"}))}, TMP_12.$$s = self, TMP_12.$$arity = 0, TMP_12), $k).call($l, $hash2(["class"], {"class": "ui inverted header"}));
                self.$DIV($hash2(["class"], {"class": "ui hidden divider"}));
                return ($k = ($m = self).$Link, $k.$$p = (TMP_14 = function(){var self = TMP_14.$$s || this;

                self.$I($hash2(["class"], {"class": "sidebar icon"}));
                  return "\n          Get Started\n        ";}, TMP_14.$$s = self, TMP_14.$$arity = 0, TMP_14), $k).call($m, "/start", $hash2(["class"], {"class": "ui big basic inverted pink view-ui button getstartedbutton"}));}, TMP_11.$$s = self, TMP_11.$$arity = 0, TMP_11), $i).call($j, $hash2(["class"], {"class": "introduction"}))}, TMP_10.$$s = self, TMP_10.$$arity = 0, TMP_10), $g).call($h, $hash2(["class"], {"class": "column"}))}, TMP_9.$$s = self, TMP_9.$$arity = 0, TMP_9), $e).call($f, $hash2(["class"], {"class": "ui page grid"}))}, TMP_8.$$s = self, TMP_8.$$arity = 0, TMP_8), $c).call($d, $hash2(["class"], {"class": "masthead segment stopped"}));
        return ($c = ($e = self).$DIV, $c.$$p = (TMP_15 = function(){var self = TMP_15.$$s || this, $f, $g, TMP_16;

        return ($f = ($g = self).$DIV, $f.$$p = (TMP_16 = function(){var self = TMP_16.$$s || this, $h, $i, TMP_17, $j, TMP_21, $k, TMP_25;

          ($h = ($i = self).$DIV, $h.$$p = (TMP_17 = function(){var self = TMP_17.$$s || this, $j, $k, TMP_18, $l, TMP_19, $m, TMP_20;

            ($j = ($k = self).$H2, $j.$$p = (TMP_18 = function(){var self = TMP_18.$$s || this;

              self.$IMG($hash2(["class", "src"], {"class": "ui icon image", "src": "dist/images/icons/paint.png"}));
                return "Simplicity";}, TMP_18.$$s = self, TMP_18.$$arity = 0, TMP_18), $j).call($k, $hash2(["class"], {"class": "ui icon header"}));
              ($j = ($l = self).$P, $j.$$p = (TMP_19 = function(){var self = TMP_19.$$s || this;

              return "Build interactive Web applications quickly. Hyperloop encourages rapid development with clean, pragmatic design. With developer productivity as our highest goal, Hyperloop takes care of much of the hassle of Web development, so you can focus on innovation and delivering end-user value."}, TMP_19.$$s = self, TMP_19.$$arity = 0, TMP_19), $j).call($l);
              return ($j = ($m = self).$A, $j.$$p = (TMP_20 = function(){var self = TMP_20.$$s || this;

              return "Simplicity"}, TMP_20.$$s = self, TMP_20.$$arity = 0, TMP_20), $j).call($m, $hash2(["href", "class"], {"href": "", "class": "ui secondary large button"}));}, TMP_17.$$s = self, TMP_17.$$arity = 0, TMP_17), $h).call($i, $hash2(["class"], {"class": "column"}));
            ($h = ($j = self).$DIV, $h.$$p = (TMP_21 = function(){var self = TMP_21.$$s || this, $k, $l, TMP_22, $m, TMP_23, $n, TMP_24;

            ($k = ($l = self).$H2, $k.$$p = (TMP_22 = function(){var self = TMP_22.$$s || this;

              self.$IMG($hash2(["class", "src"], {"class": "ui icon image", "src": "dist/images/icons/gear.png"}));
                return "Isomorphic Ruby";}, TMP_22.$$s = self, TMP_22.$$arity = 0, TMP_22), $k).call($l, $hash2(["class"], {"class": "ui icon header"}));
              ($k = ($m = self).$P, $k.$$p = (TMP_23 = function(){var self = TMP_23.$$s || this;

              return "One language. One model. One set of tests. The same business logic and domain models running on the clients and the server. Hyperloop is fully integrated with Rails and also gives you unfettered access to the complete universe of JavaScript libraries (including React) from within your Ruby code. Hyperloop lets you build beautiful interactive user interfaces in Ruby."}, TMP_23.$$s = self, TMP_23.$$arity = 0, TMP_23), $k).call($m);
              return ($k = ($n = self).$A, $k.$$p = (TMP_24 = function(){var self = TMP_24.$$s || this;

              return "Isomorphic Ruby"}, TMP_24.$$s = self, TMP_24.$$arity = 0, TMP_24), $k).call($n, $hash2(["href", "class"], {"href": "", "class": "ui pink large button hyperlooppinkbutton"}));}, TMP_21.$$s = self, TMP_21.$$arity = 0, TMP_21), $h).call($j, $hash2(["class"], {"class": "column"}));
            return ($h = ($k = self).$DIV, $h.$$p = (TMP_25 = function(){var self = TMP_25.$$s || this, $l, $m, TMP_26, $n, TMP_27, $o, TMP_28;

            ($l = ($m = self).$H2, $l.$$p = (TMP_26 = function(){var self = TMP_26.$$s || this;

              self.$IMG($hash2(["class", "src"], {"class": "ui icon image", "src": "dist/images/icons/plugin.png"}));
                return "Complete Architecture";}, TMP_26.$$s = self, TMP_26.$$arity = 0, TMP_26), $l).call($m, $hash2(["class"], {"class": "ui icon header"}));
              ($l = ($n = self).$P, $l.$$p = (TMP_27 = function(){var self = TMP_27.$$s || this;

              return "Everything has a place in our architecture. Components deliver interactive user experiences, Operations encapsulate business logic, Models magically synchronize data between clients and servers, Policies govern authorization and Stores hold local state."}, TMP_27.$$s = self, TMP_27.$$arity = 0, TMP_27), $l).call($n);
              return ($l = ($o = self).$A, $l.$$p = (TMP_28 = function(){var self = TMP_28.$$s || this;

              return "Complete Architecture"}, TMP_28.$$s = self, TMP_28.$$arity = 0, TMP_28), $l).call($o, $hash2(["href", "class"], {"href": "", "class": "ui black large button"}));}, TMP_25.$$s = self, TMP_25.$$arity = 0, TMP_25), $h).call($k, $hash2(["class"], {"class": "column"}));}, TMP_16.$$s = self, TMP_16.$$arity = 0, TMP_16), $f).call($g, $hash2(["class"], {"class": "ui three column equal height center aligned divided relaxed stackable page grid"}))}, TMP_15.$$s = self, TMP_15.$$arity = 0, TMP_15), $c).call($e, $hash2(["class"], {"class": "feature alternate ui vertical stripe segment"}));}, TMP_7.$$s = self, TMP_7.$$arity = 0, TMP_7), $a).call($b, $hash2(["class"], {"class": "full height"}));
      return self.$AppFooter();
    }, TMP_29.$$arity = 0), nil) && 'main_content';
  })($scope.base, (((($scope.get('Hyperloop')).$$scope.get('Router'))).$$scope.get('Component')))
};

/* Generated by Opal 0.10.5 */
Opal.modules["components/home/home_body"] = function(Opal) {
  var self = Opal.top, $scope = Opal, nil = Opal.nil, $breaker = Opal.breaker, $slice = Opal.slice;
...
/* Generated by Opal 0.10.5 */
Opal.modules["components/home/home_sidebar"] = function(Opal) {
  var self = Opal.top, $scope = Opal, nil = Opal.nil, $breaker = Opal.breaker, $slice = Opal.slice;
...
/* Generated by Opal 0.10.5 */
Opal.modules["components/gems/gems_body"] = function(Opal) {
  var self = Opal.top, $scope = Opal, nil = Opal.nil, $breaker = Opal.breaker, $slice = Opal.slice, $klass = Opal.klass;

  Opal.add_stubs(['$render', '$H1']);
  return (function($base, $super) {
    function $GemsBody(){};
    var self = $GemsBody = $klass($base, $super, 'GemsBody', $GemsBody);
    ...
    return ($c = ($d = self).$H1, $c.$$p = (TMP_2 = function(){var self = TMP_2.$$s || this;
      ...
      return "Gems body"}, TMP_2.$$s = self, TMP_2.$$arity = 0, TMP_2), $c).call($d)}, TMP_1.$$s = self, TMP_1.$$arity = 0, TMP_1), $a).call($b, $scope.get('DIV'))
  })($scope.base, (($scope.get('Hyperloop')).$$scope.get('Component')))
};

/* Generated by Opal 0.10.5 */
Opal.modules["components/gems/gems_sidebar"] = function(Opal) {
  var self = Opal.top, $scope = Opal, nil = Opal.nil, $breaker = Opal.breaker, $slice = Opal.slice, $klass = Opal.klass;

  Opal.add_stubs(['$render', '$H1']);
  return (function($base, $super) {
    function $GemsSidebar(){};
    var self = $GemsSidebar = $klass($base, $super, 'GemsSidebar', $GemsSidebar);
    ...
    return ($c = ($d = self).$H1, $c.$$p = (TMP_2 = function(){var self = TMP_2.$$s || this;
      ...
      return "Gems sidebar"}, TMP_2.$$s = self, TMP_2.$$arity = 0, TMP_2), $c).call($d)}, TMP_1.$$s = self, TMP_1.$$arity = 0, TMP_1), $a).call($b, $scope.get('DIV'))
  })($scope.base, (($scope.get('Hyperloop')).$$scope.get('Component')))
};

/* Generated by Opal 0.10.5 */
Opal.modules["components/gems/gems_page"] = function(Opal) {
  var self = Opal.top, $scope = Opal, nil = Opal.nil, $breaker = Opal.breaker, $slice = Opal.slice, $klass = Opal.klass, $hash2 = Opal.hash2;

  Opal.add_stubs(['$render', '$as_node', '$GemsSidebar', '$GemsBody', '$PageLayout']);
  return (function($base, $super) {
    function $GemsPage(){};
    var self = $GemsPage = $klass($base, $super, 'GemsPage', $GemsPage);

    var def = self.$$proto, $scope = self.$$scope, $a, $b, TMP_1;

    return ($a = ($b = self).$render, $a.$$p = (TMP_1 = function(){var self = TMP_1.$$s || this, sidebar = nil, body = nil;

    sidebar = self.$GemsSidebar().$as_node();
      body = self.$GemsBody().$as_node();
      return self.$PageLayout($hash2(["sidebar_component", "body_component", "loaded"], {"sidebar_component": sidebar, "body_component": body, "loaded": true}));}, TMP_1.$$s = self, TMP_1.$$arity = 0, TMP_1), $a).call($b, $scope.get('DIV'))
  })($scope.base, (((($scope.get('Hyperloop')).$$scope.get('Router'))).$$scope.get('Component')))
};

/* Generated by Opal 0.10.5 */
Opal.modules["components/shared/page_layout"] = function(Opal) {
  var self = Opal.top, $scope = Opal, nil = Opal.nil, $breaker = Opal.breaker, $slice = Opal.slice, $klass = Opal.klass, $hash2 = Opal.hash2;

  Opal.add_stubs(['$param', '$before_mount', '$hide', '$after_mount', '$on', '$[]', '$render', '$DIV', '$SidebarMenu', '$main_content', '$AppMenu', '$section', '$params', '$page_title', '$P', '$sidebar_component', '$body_component', '$AppFooter', '$SearchResultModal']);
  return (function($base, $super) {
    function $PageLayout(){};
    var self = $PageLayout = $klass($base, $super, 'PageLayout', $PageLayout);

    var def = self.$$proto, $scope = self.$$scope, $a, $b, TMP_1, $c, TMP_2, $d, TMP_4, TMP_14;

    self.$param("sidebar_component");

    self.$param("body_component");

    self.$param("page_title");
    ...
    return (Opal.defn(self, '$main_content', TMP_14 = function $$main_content() {
      var $a, $b, TMP_7, self = this;

      ($a = ($b = self).$DIV, $a.$$p = (TMP_7 = function(){var self = TMP_7.$$s || this, $c, $d, TMP_8, $e, TMP_13;

      self.$AppMenu($hash2(["section"], {"section": self.$params().$section()}));
        ($c = ($d = self).$DIV, $c.$$p = (TMP_8 = function(){var self = TMP_8.$$s || this, $e, $f, TMP_9;

        return ($e = ($f = self).$DIV, $e.$$p = (TMP_9 = function(){var self = TMP_9.$$s || this, $g, $h, TMP_10;

          return ($g = ($h = self).$DIV, $g.$$p = (TMP_10 = function(){var self = TMP_10.$$s || this, $i, $j, TMP_11, $k, TMP_12;

            ($i = ($j = self).$DIV, $i.$$p = (TMP_11 = function(){var self = TMP_11.$$s || this;

              return self.$params().$page_title()}, TMP_11.$$s = self, TMP_11.$$arity = 0, TMP_11), $i).call($j, $hash2(["class"], {"class": "ui huge header"}));
              return ($i = ($k = self).$P, $i.$$p = (TMP_12 = function(){var self = TMP_12.$$s || this;

              return "The Complete Isomorphic Ruby Framework"}, TMP_12.$$s = self, TMP_12.$$arity = 0, TMP_12), $i).call($k);}, TMP_10.$$s = self, TMP_10.$$arity = 0, TMP_10), $g).call($h, $hash2(["class"], {"class": "introductiontitle"}))}, TMP_9.$$s = self, TMP_9.$$arity = 0, TMP_9), $e).call($f, $hash2(["class"], {"class": "container"}))}, TMP_8.$$s = self, TMP_8.$$arity = 0, TMP_8), $c).call($d, $hash2(["class"], {"class": "header segment"}));
        return ($c = ($e = self).$DIV, $c.$$p = (TMP_13 = function(){var self = TMP_13.$$s || this;

        self.$params().$sidebar_component().$render();
          return self.$params().$body_component().$render();}, TMP_13.$$s = self, TMP_13.$$arity = 0, TMP_13), $c).call($e, $hash2(["class"], {"class": "main container"}));}, TMP_7.$$s = self, TMP_7.$$arity = 0, TMP_7), $a).call($b, $hash2(["class"], {"class": "full height"}));
      self.$AppFooter();
      return self.$SearchResultModal();
    }, TMP_14.$$arity = 0), nil) && 'main_content';
  })($scope.base, (((($scope.get('Hyperloop')).$$scope.get('Router'))).$$scope.get('Component')))
};
...
Opal.modules["components/shared/site_search"] = function(Opal) {
  ...
  Opal.add_stubs(['$state', '$param', '$render', '$search_control', '$Input', '$on', '$value', '$mutate', '$target', '$INPUT', '$Icon', '$Select', '$to_n', '$options', '$params', '$section', '$show', '$>', '$length', '$!=', '$inputvalue', '$allresults', '$inputvaluetoosmall', '$Button', '$SPAN', '$H4', '$EM', '$H1']);
  return (function($base, $super) {
    function $SiteSearch(){};
    var self = $SiteSearch = $klass($base, $super, 'SiteSearch', $SiteSearch);

    var def = self.$$proto, $scope = self.$$scope, $a, $b, TMP_1, TMP_7, TMP_11, TMP_15;
    ...
    self.$param($hash2(["options"], {"options": [$hash2(["key", "text", "value"], {"key": "docs", "text": "Documentation", "value": "docs"}), $hash2(["key", "text", "value"], {"key": "start", "text": "Get started", "value": "start"}), $hash2(["key", "text", "value"], {"key": "tutorials", "text": "Tutorials", "value": "tutorials"})]}));
    ...
    Opal.defn(self, '$search_control', TMP_7 = function $$search_control() {
      var $a, $b, TMP_2, self = this;

      return ($a = ($b = $scope.get('Sem')).$Input, $a.$$p = (TMP_2 = function(){var self = TMP_2.$$s || this, $c, $d, TMP_3, $e, $f, TMP_4, TMP_5, $g, $h, TMP_6;

      ($c = ($d = ($e = ($f = self).$INPUT, $e.$$p = (TMP_4 = function(){var self = TMP_4.$$s || this;

        return nil}, TMP_4.$$s = self, TMP_4.$$arity = 0, TMP_4), $e).call($f)).$on, $c.$$p = (TMP_3 = function(e){var self = TMP_3.$$s || this;
if (e == null) e = nil;
        return self.$mutate().$value(e.$target().$value())}, TMP_3.$$s = self, TMP_3.$$arity = 1, TMP_3), $c).call($d, "change");
        $scope.get('Sem').$Icon($hash2(["name"], {"name": "search"}));
        $scope.get('Sem').$Select($hash2(["compact", "options", "defaultValue"], {"compact": true, "options": self.$params().$options().$to_n(), "defaultValue": self.$params().$section().$to_n()}));
        return ($c = ($e = ($g = ($h = $scope.get('Sem')).$Button, $g.$$p = (TMP_6 = function(){var self = TMP_6.$$s || this;

        return "Search"}, TMP_6.$$s = self, TMP_6.$$arity = 0, TMP_6), $g).call($h, $hash2(["type"], {"type": "submit"}))).$on, $c.$$p = (TMP_5 = function(){var self = TMP_5.$$s || this, $g;

        $scope.get('SearchResultModalStore').$show();
          if ((($g = ($rb_gt(self.$state().$value().$length(), 4))) !== nil && $g != null && (!$g.$$is_boolean || $g == true))) {
            if ((($g = ($scope.get('SearchEngineStore').$inputvalue()['$!='](self.$state().$value()))) !== nil && $g != null && (!$g.$$is_boolean || $g == true))) {
              $scope.get('SearchEngineStore').$mutate().$inputvalue(self.$state().$value());
              return $scope.get('SearchEngineStore').$mutate().$allresults(nil);
              } else {
              return nil
            }
            } else {
            $scope.get('SearchEngineStore').$mutate().$inputvalue("");
            $scope.get('SearchEngineStore').$mutate().$allresults(nil);
            return $scope.get('SearchEngineStore').$mutate().$inputvaluetoosmall("Please provide a search value > 4");
          };}, TMP_5.$$s = self, TMP_5.$$arity = 0, TMP_5), $c).call($e, "click");}, TMP_2.$$s = self, TMP_2.$$arity = 0, TMP_2), $a).call($b, $hash2(["iconPosition", "placeholder", "action"], {"iconPosition": "left", "placeholder": "Search ...", "action": true}));
    }, TMP_7.$$arity = 0);

    Opal.defn(self, '$render_result', TMP_11 = function $$render_result(obj) {
      var $a, $b, TMP_8, self = this;

      return ($a = ($b = self).$SPAN, $a.$$p = (TMP_8 = function(){var self = TMP_8.$$s || this, $c, $d, TMP_9, $e, TMP_10;

      ($c = ($d = self).$H4, $c.$$p = (TMP_9 = function(){var self = TMP_9.$$s || this;

        return obj.text;}, TMP_9.$$s = self, TMP_9.$$arity = 0, TMP_9), $c).call($d);
        return ($c = ($e = self).$EM, $c.$$p = (TMP_10 = function(){var self = TMP_10.$$s || this;

        return obj.friendly_doc_name;}, TMP_10.$$s = self, TMP_10.$$arity = 0, TMP_10), $c).call($e);}, TMP_8.$$s = self, TMP_8.$$arity = 0, TMP_8), $a).call($b).$to_n();
    }, TMP_11.$$arity = 1);

    return (Opal.defn(self, '$render_category', TMP_15 = function $$render_category(obj) {
      var $a, $b, TMP_12, self = this;

      return ($a = ($b = self).$SPAN, $a.$$p = (TMP_12 = function(){var self = TMP_12.$$s || this, $c, $d, TMP_13, $e, TMP_14;

      ($c = ($d = self).$H1, $c.$$p = (TMP_13 = function(){var self = TMP_13.$$s || this;

        return obj.name;}, TMP_13.$$s = self, TMP_13.$$arity = 0, TMP_13), $c).call($d);
        return ($c = ($e = self).$EM, $c.$$p = (TMP_14 = function(){var self = TMP_14.$$s || this;

        return "" + (obj.result_number) + " results"}, TMP_14.$$s = self, TMP_14.$$arity = 0, TMP_14), $c).call($e);}, TMP_12.$$s = self, TMP_12.$$arity = 0, TMP_12), $a).call($b).$to_n();
    }, TMP_15.$$arity = 1), nil) && 'render_category';
  })($scope.base, (($scope.get('Hyperloop')).$$scope.get('Component')))
};
...
/* Generated by Opal 0.10.5 */
Opal.modules["components/shared/search_result_modal"] = function(Opal) {
  var self = Opal.top, $scope = Opal, nil = Opal.nil, $breaker = Opal.breaker, $slice = Opal.slice, $klass = Opal.klass, $hash2 = Opal.hash2;

  Opal.add_stubs(['$render', '$Modal', '$ModalHeader', '$ModalContent', '$Image', '$ModalDescription', '$HEADER', '$P', '$inputvaluetoosmall', '$inputvalue', '$visible', '$search_content', '$allresults', '$ModalActions', '$on', '$hide', '$Button']);
  return (function($base, $super) {
    function $SearchResultModal(){};
    var self = $SearchResultModal = $klass($base, $super, 'SearchResultModal', $SearchResultModal);

    var def = self.$$proto, $scope = self.$$scope, $a, $b, TMP_1;

    return ($a = ($b = self).$render, $a.$$p = (TMP_1 = function(){var self = TMP_1.$$s || this, $c, $d, TMP_2, $e;

    return ($c = ($d = $scope.get('Sem')).$Modal, $c.$$p = (TMP_2 = function(){var self = TMP_2.$$s || this, $e, $f, TMP_3, $g, TMP_4, $h, TMP_11;

      ($e = ($f = $scope.get('Sem')).$ModalHeader, $e.$$p = (TMP_3 = function(){var self = TMP_3.$$s || this;

        return "Search Results: "}, TMP_3.$$s = self, TMP_3.$$arity = 0, TMP_3), $e).call($f);
        ($e = ($g = $scope.get('Sem')).$ModalContent, $e.$$p = (TMP_4 = function(){var self = TMP_4.$$s || this, $h, $i, TMP_5, $j, TMP_6;

        ($h = ($i = $scope.get('Sem')).$Image, $h.$$p = (TMP_5 = function(){var self = TMP_5.$$s || this;

          return nil}, TMP_5.$$s = self, TMP_5.$$arity = 0, TMP_5), $h).call($i, $hash2(["size", "src", "wrapped"], {"size": "massive", "src": "dist/images/hyperloop-logo-title.png", "wrapped": true}));
          return ($h = ($j = $scope.get('Sem')).$ModalDescription, $h.$$p = (TMP_6 = function(){var self = TMP_6.$$s || this, $k, $l, TMP_7, $m, TMP_8, $n, TMP_9, $o, TMP_10;

          ($k = ($l = self).$HEADER, $k.$$p = (TMP_7 = function(){var self = TMP_7.$$s || this;

            return "RESULTS LISTING"}, TMP_7.$$s = self, TMP_7.$$arity = 0, TMP_7), $k).call($l);
            ($k = ($m = self).$P, $k.$$p = (TMP_8 = function(){var self = TMP_8.$$s || this;

            return $scope.get('SearchEngineStore').$inputvaluetoosmall()}, TMP_8.$$s = self, TMP_8.$$arity = 0, TMP_8), $k).call($m);
            ($k = ($n = self).$P, $k.$$p = (TMP_9 = function(){var self = TMP_9.$$s || this;

            return $scope.get('SearchEngineStore').$inputvalue()}, TMP_9.$$s = self, TMP_9.$$arity = 0, TMP_9), $k).call($n);
            return ($k = ($o = self).$P, $k.$$p = (TMP_10 = function(){var self = TMP_10.$$s || this, $p;

            if ((($p = ($scope.get('SearchResultModalStore').$visible())) !== nil && $p != null && (!$p.$$is_boolean || $p == true))) {
                $scope.get('SearchEngineStore').$search_content("docs");
                return "Results: " + ($scope.get('SearchEngineStore').$allresults());
                } else {
                return nil
              }}, TMP_10.$$s = self, TMP_10.$$arity = 0, TMP_10), $k).call($o);}, TMP_6.$$s = self, TMP_6.$$arity = 0, TMP_6), $h).call($j);}, TMP_4.$$s = self, TMP_4.$$arity = 0, TMP_4), $e).call($g, $hash2(["image", "scrolling"], {"image": true, "scrolling": true}));
        return ($e = ($h = $scope.get('Sem')).$ModalActions, $e.$$p = (TMP_11 = function(){var self = TMP_11.$$s || this, $i, $j, TMP_12, $k, $l, TMP_13;

        return ($i = ($j = ($k = ($l = $scope.get('Sem')).$Button, $k.$$p = (TMP_13 = function(){var self = TMP_13.$$s || this;

          return "Close"}, TMP_13.$$s = self, TMP_13.$$arity = 0, TMP_13), $k).call($l, $hash2(["negative"], {"negative": true}))).$on, $i.$$p = (TMP_12 = function(){var self = TMP_12.$$s || this;

          return $scope.get('SearchResultModalStore').$hide()}, TMP_12.$$s = self, TMP_12.$$arity = 0, TMP_12), $i).call($j, "click")}, TMP_11.$$s = self, TMP_11.$$arity = 0, TMP_11), $e).call($h);}, TMP_2.$$s = self, TMP_2.$$arity = 0, TMP_2), $c).call($d, $hash2(["size", "open"], {"size": "large", "open": ((function() {if ((($e = $scope.get('SearchResultModalStore').$visible()) !== nil && $e != null && (!$e.$$is_boolean || $e == true))) {
        return true
        } else {
        return false
...
Opal.modules["components/shared/md_converter"] = function(Opal) {
  ...
  Opal.add_stubs(['$gsub', '$process', '$lambda', '$on_heading', '$on_code', '$on_codespan', '$on_blockquote', '$on_table', '$[]=', '$highlight', '$<<', '$[]', '$downcase']);
  return (function($base, $super) {
    function $MdConverter(){};
    var self = $MdConverter = $klass($base, $super, 'MdConverter', $MdConverter);

    var def = self.$$proto, $scope = self.$$scope, TMP_1, TMP_2, TMP_3, TMP_4, TMP_10, TMP_11, TMP_12, TMP_13, TMP_14, TMP_15, TMP_16;

    def.html = def.code_blocks = def.headings = def.md = nil;
    Opal.defn(self, '$initialize', TMP_1 = function $$initialize(md) {
      var self = this;

      self.md = md.$gsub("ruby runable", "ruby-runable");
      self.headings = [];
      self.code_blocks = [];
      return self.$process();
    }, TMP_1.$$arity = 1);

    Opal.defn(self, '$html', TMP_2 = function $$html() {
      var self = this;

      return self.html;
    }, TMP_2.$$arity = 0);

    Opal.defn(self, '$code_blocks', TMP_3 = function $$code_blocks() {
      var self = this;

      return self.code_blocks;
    }, TMP_3.$$arity = 0);

    Opal.defn(self, '$headings', TMP_4 = function $$headings() {
      var self = this;

      return self.headings;
    }, TMP_4.$$arity = 0);

    Opal.defn(self, '$process', TMP_10 = function $$process() {
...
if (text == null) text = nil;if (level == null) level = nil;
      return self.$on_heading(text, level)}, TMP_5.$$s = self, TMP_5.$$arity = 2, TMP_5), $a).call($b);
      renderer.code = ($a = ($c = self).$lambda, $a.$$p = (TMP_6 = function(code, lang){var self = TMP_6.$$s || this;
if (code == null) code = nil;if (lang == null) lang = nil;
      return self.$on_code(code, lang)}, TMP_6.$$s = self, TMP_6.$$arity = 2, TMP_6), $a).call($c);
      renderer.codespan = ($a = ($d = self).$lambda, $a.$$p = (TMP_7 = function(code){var self = TMP_7.$$s || this;
if (code == null) code = nil;
      return self.$on_codespan(code)}, TMP_7.$$s = self, TMP_7.$$arity = 1, TMP_7), $a).call($d);
      renderer.blockquote = ($a = ($e = self).$lambda, $a.$$p = (TMP_8 = function(quote){var self = TMP_8.$$s || this;
if (quote == null) quote = nil;
      return self.$on_blockquote(quote)}, TMP_8.$$s = self, TMP_8.$$arity = 1, TMP_8), $a).call($e);
      renderer.table = ($a = ($f = self).$lambda, $a.$$p = (TMP_9 = function(header, body){var self = TMP_9.$$s || this;
if (header == null) header = nil;if (body == null) body = nil;
      return self.$on_table(header, body)}, TMP_9.$$s = self, TMP_9.$$arity = 2, TMP_9), $a).call($f);
      Marked.setOptions({ renderer: renderer });
      return self.html = Marked(self.md);
    }, TMP_10.$$arity = 0);

    Opal.defn(self, '$on_table', TMP_11 = function $$on_table(header, body) {
      var self = this;

      return "<table class='ui celled table'><thead class>" + (header) + "</thead><tbody class>" + (body) + "</tbody></table>";
    }, TMP_11.$$arity = 2);

    Opal.defn(self, '$on_code', TMP_12 = function $$on_code(code, lang) {
    ...
    Opal.defn(self, '$on_codespan', TMP_13 = function $$on_codespan(code) {
      var self = this;

      return "<code class='inline-codespan'>" + (code) + "</code>";
    }, TMP_13.$$arity = 1);

    Opal.defn(self, '$highlight', TMP_14 = function $$highlight(code, lang) {
      var self = this;
    ...
    Opal.defn(self, '$on_blockquote', TMP_15 = function $$on_blockquote(quote) {
      var self = this;

      return "<div class='ui cards'><div class='ui card fluid'><div class='content'>" + (quote) + "</div></div></div>";
    }, TMP_15.$$arity = 1);

    return (Opal.defn(self, '$on_heading', TMP_16 = function $$on_heading(text, level) {
...
/* Generated by Opal 0.10.5 */
Opal.modules["components/shared/app_footer"] = function(Opal) {
  var self = Opal.top, $scope = Opal, nil = Opal.nil, $breaker = Opal.breaker, $slice = Opal.slice, $klass = Opal.klass, $hash2 = Opal.hash2;

  Opal.add_stubs(['$render', '$DIV', '$H3', '$P', '$FORM', '$INPUT', '$BUTTON', '$H5', '$A']);
  return (function($base, $super) {
    function $AppFooter(){};
    var self = $AppFooter = $klass($base, $super, 'AppFooter', $AppFooter);
    ...
    return ($c = ($d = self).$DIV, $c.$$p = (TMP_2 = function(){var self = TMP_2.$$s || this, $e, $f, TMP_3;
      ...
      return ($e = ($f = self).$DIV, $e.$$p = (TMP_3 = function(){var self = TMP_3.$$s || this, $g, $h, TMP_4;

        return ($g = ($h = self).$DIV, $g.$$p = (TMP_4 = function(){var self = TMP_4.$$s || this, $i, $j, TMP_5, $k, TMP_10, $l, TMP_17;

          ($i = ($j = self).$DIV, $i.$$p = (TMP_5 = function(){var self = TMP_5.$$s || this, $k, $l, TMP_6, $m, TMP_7, $n, TMP_8;

            ($k = ($l = self).$H3, $k.$$p = (TMP_6 = function(){var self = TMP_6.$$s || this;

              return "Hyperloop"}, TMP_6.$$s = self, TMP_6.$$arity = 0, TMP_6), $k).call($l, $hash2(["class"], {"class": "ui inverted header"}));
              ($k = ($m = self).$P, $k.$$p = (TMP_7 = function(){var self = TMP_7.$$s || this;

              return "Nec minus feminae quoque calamitatum participes fuere similium. nam ex hoc quoque sexu peremptae sunt originis altae conplures"}, TMP_7.$$s = self, TMP_7.$$arity = 0, TMP_7), $k).call($m);
              return ($k = ($n = self).$FORM, $k.$$p = (TMP_8 = function(){var self = TMP_8.$$s || this, $o, $p, TMP_9;

              self.$INPUT($hash2(["type", "name", "value"], {"type": "hidden", "name": "cmd", "value": "_s-xclick"}));
                self.$INPUT($hash2(["type", "name", "value"], {"type": "hidden", "name": "hosted_button_id", "value": "7ZAF2Q8DBZAQL"}));
                return ($o = ($p = self).$BUTTON, $o.$$p = (TMP_9 = function(){var self = TMP_9.$$s || this;

                return "Hyperloop"}, TMP_9.$$s = self, TMP_9.$$arity = 0, TMP_9), $o).call($p, $hash2(["type", "class"], {"type": "submit", "class": "ui pink hyperlooppinkbutton button"}));}, TMP_8.$$s = self, TMP_8.$$arity = 0, TMP_8), $k).call($n, $hash2(["action", "method", "target"], {"action": "", "method": "post", "target": "_top"}));}, TMP_5.$$s = self, TMP_5.$$arity = 0, TMP_5), $i).call($j, $hash2(["class"], {"class": "eight wide column"}));
            ($i = ($k = self).$DIV, $i.$$p = (TMP_10 = function(){var self = TMP_10.$$s || this, $l, $m, TMP_11, $n, TMP_12;

            ($l = ($m = self).$H5, $l.$$p = (TMP_11 = function(){var self = TMP_11.$$s || this;

              return "Contribute"}, TMP_11.$$s = self, TMP_11.$$arity = 0, TMP_11), $l).call($m, $hash2(["class"], {"class": "ui pink inverted header hyperlooppink"}));
              return ($l = ($n = self).$DIV, $l.$$p = (TMP_12 = function(){var self = TMP_12.$$s || this, $o, $p, TMP_13, $q, TMP_14, $r, TMP_15, $s, TMP_16;

              ($o = ($p = self).$A, $o.$$p = (TMP_13 = function(){var self = TMP_13.$$s || this;

                return "Translate"}, TMP_13.$$s = self, TMP_13.$$arity = 0, TMP_13), $o).call($p, $hash2(["class", "href"], {"class": "item", "href": ""}));
                ($o = ($q = self).$A, $o.$$p = (TMP_14 = function(){var self = TMP_14.$$s || this;

                return "Issue Tracker"}, TMP_14.$$s = self, TMP_14.$$arity = 0, TMP_14), $o).call($q, $hash2(["class", "href", "target"], {"class": "item", "href": "", "target": "_blank"}));
                ($o = ($r = self).$A, $o.$$p = (TMP_15 = function(){var self = TMP_15.$$s || this;

                return "CLA"}, TMP_15.$$s = self, TMP_15.$$arity = 0, TMP_15), $o).call($r, $hash2(["class", "href", "target"], {"class": "item", "href": "", "target": "_blank"}));
                return ($o = ($s = self).$A, $o.$$p = (TMP_16 = function(){var self = TMP_16.$$s || this;

                return "others"}, TMP_16.$$s = self, TMP_16.$$arity = 0, TMP_16), $o).call($s, $hash2(["class"], {"class": "disabled item"}));}, TMP_12.$$s = self, TMP_12.$$arity = 0, TMP_12), $l).call($n, $hash2(["class"], {"class": "ui inverted link list"}));}, TMP_10.$$s = self, TMP_10.$$arity = 0, TMP_10), $i).call($k, $hash2(["class"], {"class": "four wide column"}));
            return ($i = ($l = self).$DIV, $i.$$p = (TMP_17 = function(){var self = TMP_17.$$s || this, $m, $n, TMP_18, $o, TMP_19;

            ($m = ($n = self).$H5, $m.$$p = (TMP_18 = function(){var self = TMP_18.$$s || this;

              return "Hyperloop Network"}, TMP_18.$$s = self, TMP_18.$$arity = 0, TMP_18), $m).call($n, $hash2(["class"], {"class": "ui pink inverted header hyperlooppink"}));
              return ($m = ($o = self).$DIV, $m.$$p = (TMP_19 = function(){var self = TMP_19.$$s || this, $p, $q, TMP_20, $r, TMP_21, $s, TMP_22, $t, TMP_23;

              ($p = ($q = self).$A, $p.$$p = (TMP_20 = function(){var self = TMP_20.$$s || this;

                return "Gitter"}, TMP_20.$$s = self, TMP_20.$$arity = 0, TMP_20), $p).call($q, $hash2(["class", "href", "target"], {"class": "item", "href": "", "target": "_blank"}));
                ($p = ($r = self).$A, $p.$$p = (TMP_21 = function(){var self = TMP_21.$$s || this;

                return ""}, TMP_21.$$s = self, TMP_21.$$arity = 0, TMP_21), $p).call($r, $hash2(["href", "class"], {"href": "", "class": "item"}));
                ($p = ($s = self).$A, $p.$$p = (TMP_22 = function(){var self = TMP_22.$$s || this;

                return ""}, TMP_22.$$s = self, TMP_22.$$arity = 0, TMP_22), $p).call($s, $hash2(["href", "class"], {"href": "", "class": "item"}));
                return ($p = ($t = self).$A, $p.$$p = (TMP_23 = function(){var self = TMP_23.$$s || this;

                return ""}, TMP_23.$$s = self, TMP_23.$$arity = 0, TMP_23), $p).call($t, $hash2(["class"], {"class": "disabled item"}));}, TMP_19.$$s = self, TMP_19.$$arity = 0, TMP_19), $m).call($o, $hash2(["class"], {"class": "ui inverted link list"}));}, TMP_17.$$s = self, TMP_17.$$arity = 0, TMP_17), $i).call($l, $hash2(["class"], {"class": "four wide column"}));}, TMP_4.$$s = self, TMP_4.$$arity = 0, TMP_4), $g).call($h, $hash2(["class"], {"class": "ui stackable inverted divided relaxed grid"}))}, TMP_3.$$s = self, TMP_3.$$arity = 0, TMP_3), $e).call($f, $hash2(["class"], {"class": "container"}))}, TMP_2.$$s = self, TMP_2.$$arity = 0, TMP_2), $c).call($d, $hash2(["class"], {"class": "ui vertical inverted black footer segment"}))}, TMP_1.$$s = self, TMP_1.$$arity = 0, TMP_1), $a).call($b)
  })($scope.base, (((($scope.get('Hyperloop')).$$scope.get('Router'))).$$scope.get('Component')))
};
...
Opal.modules["components/shared/app_menu"] = function(Opal) {
  ...
  Opal.add_stubs(['$param', '$render', '$DIV', '$IMG', '$IFRAME', '$I', '$on', '$toggle', '$A', '$!=', '$section', '$params', '$MenuItem', '$SiteSearch']);
  return (function($base, $super) {
    function $AppMenu(){};
    ...
    return ($c = ($d = self).$DIV, $c.$$p = (TMP_2 = function(){var self = TMP_2.$$s || this, $e, $f, TMP_3;
      ...
      return ($e = ($f = self).$DIV, $e.$$p = (TMP_3 = function(){var self = TMP_3.$$s || this, $g, $h, TMP_4;
        ...
        return ($g = ($h = self).$DIV, $g.$$p = (TMP_4 = function(){var self = TMP_4.$$s || this, $i, $j, TMP_5, $k, TMP_8, $l, TMP_12;

          ($i = ($j = self).$DIV, $i.$$p = (TMP_5 = function(){var self = TMP_5.$$s || this, $k, $l, TMP_6;

            return ($k = ($l = self).$DIV, $k.$$p = (TMP_6 = function(){var self = TMP_6.$$s || this, $m, $n, TMP_7;
            ...
            ($l = ($m = self).$DIV, $l.$$p = (TMP_9 = function(){var self = TMP_9.$$s || this;
              ...
              return self.$IFRAME($hash2(["class", "src", "allowTransparency", "frameBorder", "scrolling", "width", "height"], {"class": "github", "src": "http://ghbtns.com/github-btn.html?user=ruby-hyperloop&repo=hyperloop&type=watch&count=true", "allowTransparency": "true", "frameBorder": "0", "scrolling": "0", "width": "100", "height": "20"}))}, TMP_9.$$s = self, TMP_9.$$arity = 0, TMP_9), $l).call($m, $hash2(["class"], {"class": "item"}));
              return ($l = ($n = self).$DIV, $l.$$p = (TMP_10 = function(){var self = TMP_10.$$s || this, $o, $p, TMP_11;
            ...
            ($m = ($n = ($o = ($p = self).$A, $o.$$p = (TMP_14 = function(){var self = TMP_14.$$s || this;
              ...
              self.$I($hash2(["class"], {"class": "sidebar icon"}));
                return " Menu\n        ";}, TMP_14.$$s = self, TMP_14.$$arity = 0, TMP_14), $o).call($p, $hash2(["class"], {"class": "view-ui item"}))).$on, $m.$$p = (TMP_13 = function(){var self = TMP_13.$$s || this;

              return $scope.get('SidebarStore').$toggle()}, TMP_13.$$s = self, TMP_13.$$arity = 0, TMP_13), $m).call($n, "click");
              ...
              if ((($m = (self.$params().$section()['$!=']("home"))) !== nil && $m != null && (!$m.$$is_boolean || $m == true))) {
                return ($m = ($r = $scope.get('Sem')).$MenuItem, $m.$$p = (TMP_17 = function(){var self = TMP_17.$$s || this;

                return self.$SiteSearch($hash2(["section"], {"section": self.$params().$section()}))}, TMP_17.$$s = self, TMP_17.$$arity = 0, TMP_17), $m).call($r)
                } else {
                return nil
              };}, TMP_12.$$s = self, TMP_12.$$arity = 0, TMP_12), $i).call($l, $hash2(["class"], {"class": "ui large secondary network menu"}));}, TMP_4.$$s = self, TMP_4.$$arity = 0, TMP_4), $g).call($h, $hash2(["class"], {"class": "column"}))}, TMP_3.$$s = self, TMP_3.$$arity = 0, TMP_3), $e).call($f, $hash2(["class"], {"class": "ui page grid"}))}, TMP_2.$$s = self, TMP_2.$$arity = 0, TMP_2), $c).call($d, $hash2(["class"], {"class": "following bar fixed"}))}, TMP_1.$$s = self, TMP_1.$$arity = 0, TMP_1), $a).call($b);
  })($scope.base, (((($scope.get('Hyperloop')).$$scope.get('Router'))).$$scope.get('Component')))
};

/* Generated by Opal 0.10.5 */
Opal.modules["components/shared/sidebar_menu"] = function(Opal) {
  var self = Opal.top, $scope = Opal, nil = Opal.nil, $breaker = Opal.breaker, $slice = Opal.slice, $klass = Opal.klass, $hash2 = Opal.hash2;

  Opal.add_stubs(['$render', '$Push', '$Link', '$IMG', '$visible']);
  return (function($base, $super) {
    function $SidebarMenu(){};
    var self = $SidebarMenu = $klass($base, $super, 'SidebarMenu', $SidebarMenu);

    var def = self.$$proto, $scope = self.$$scope, $a, $b, TMP_1;

    return ($a = ($b = self).$render, $a.$$p = (TMP_1 = function(){var self = TMP_1.$$s || this, $c, $d, TMP_2, $e;

    return ($c = ($d = $scope.get('BurgerMenu')).$Push, $c.$$p = (TMP_2 = function(){var self = TMP_2.$$s || this, $e, $f, TMP_3, $g, TMP_4, $h, TMP_5, $i, TMP_6, $j, TMP_7, $k, TMP_8, $l, TMP_9;

      ($e = ($f = self).$Link, $e.$$p = (TMP_3 = function(){var self = TMP_3.$$s || this;

        return self.$IMG($hash2(["src"], {"src": "dist/images/hyperloop-logo-title.png"}))}, TMP_3.$$s = self, TMP_3.$$arity = 0, TMP_3), $e).call($f, "/", $hash2(["class"], {"class": "header"}));
        ($e = ($g = self).$Link, $e.$$p = (TMP_4 = function(){var self = TMP_4.$$s || this;

        return "GET STARTED"}, TMP_4.$$s = self, TMP_4.$$arity = 0, TMP_4), $e).call($g, "/start");
        ($e = ($h = self).$Link, $e.$$p = (TMP_5 = function(){var self = TMP_5.$$s || this;

        return "INSTALLATION"}, TMP_5.$$s = self, TMP_5.$$arity = 0, TMP_5), $e).call($h, "/installation", $hash2(["class"], {"class": "item"}));
        ($e = ($i = self).$Link, $e.$$p = (TMP_6 = function(){var self = TMP_6.$$s || this;

        return "TUTORIALS"}, TMP_6.$$s = self, TMP_6.$$arity = 0, TMP_6), $e).call($i, "/tutorials", $hash2(["class"], {"class": "item"}));
        ($e = ($j = self).$Link, $e.$$p = (TMP_7 = function(){var self = TMP_7.$$s || this;

        return "DOCUMENTATION"}, TMP_7.$$s = self, TMP_7.$$arity = 0, TMP_7), $e).call($j, "/docs", $hash2(["class"], {"class": "item"}));
        ($e = ($k = self).$Link, $e.$$p = (TMP_8 = function(){var self = TMP_8.$$s || this;

        return "GEMS"}, TMP_8.$$s = self, TMP_8.$$arity = 0, TMP_8), $e).call($k, "/gems", $hash2(["class"], {"class": "item"}));
        return ($e = ($l = self).$Link, $e.$$p = (TMP_9 = function(){var self = TMP_9.$$s || this;

        return "TOOLS"}, TMP_9.$$s = self, TMP_9.$$arity = 0, TMP_9), $e).call($l, "/tools", $hash2(["class"], {"class": "item"}));}, TMP_2.$$s = self, TMP_2.$$arity = 0, TMP_2), $c).call($d, $hash2(["pagewrapid", "outercontainerid", "isOpen", "customBurgerIcon", "customCrossIcon", "disableOverlayClick"], {"pagewrapid": "page-wrap", "outercontainerid": "index", "isOpen": ((function() {if ((($e = $scope.get('SidebarStore').$visible()) !== nil && $e != null && (!$e.$$is_boolean || $e == true))) {
        return true
        } else {
        return false
      }; return nil; })()), "customBurgerIcon": false, "customCrossIcon": false, "disableOverlayClick": true}))}, TMP_1.$$s = self, TMP_1.$$arity = 0, TMP_1), $a).call($b)
  })($scope.base, (((($scope.get('Hyperloop')).$$scope.get('Router'))).$$scope.get('Component')))
};
...
/* Generated by Opal 0.10.5 */
Opal.modules["components/shared/page_body"] = function(Opal) {
  var self = Opal.top, $scope = Opal, nil = Opal.nil, $breaker = Opal.breaker, $slice = Opal.slice, $klass = Opal.klass, $hash2 = Opal.hash2;

  Opal.add_stubs(['$param', '$before_mount', '$needs_refresh', '$mutate', '$render', '$loaded?', '$[]', '$sections', '$section', '$params', '$current_page', '$edit_button', '$Divider', '$DIV', '$convert_runable_code_blocks', '$each', '$text', '$create_element', '$parent', '$find', '$Grid', '$GridColumn', '$state', '$Message', '$MessageHeader', '$P', '$on', '$Button']);
  return (function($base, $super) {
    function $PageBody(){};
    var self = $PageBody = $klass($base, $super, 'PageBody', $PageBody);

    var def = self.$$proto, $scope = self.$$scope, $a, $b, TMP_1, $c, TMP_2, TMP_4, TMP_12;

    self.$param("section");

    ($a = ($b = self).$before_mount, $a.$$p = (TMP_1 = function(){var self = TMP_1.$$s || this;

    return self.$mutate().$needs_refresh(false)}, TMP_1.$$s = self, TMP_1.$$arity = 0, TMP_1), $a).call($b);

    ($a = ($c = self).$render, $a.$$p = (TMP_2 = function(){var self = TMP_2.$$s || this, $d;

    if ((($d = $scope.get('SiteStore').$sections()['$[]'](self.$params().$section())['$loaded?']()) !== nil && $d != null && (!$d.$$is_boolean || $d == true))) {
        if ((($d = $scope.get('SiteStore').$sections()['$[]'](self.$params().$section()).$current_page()['$[]']("allow_edit")) !== nil && $d != null && (!$d.$$is_boolean || $d == true))) {
          self.$edit_button()};
        $scope.get('Sem').$Divider($hash2(["hidden"], {"hidden": true}));
        self.$DIV($hash2(["dangerously_set_inner_HTML"], {"dangerously_set_inner_HTML": $hash2(["__html"], {"__html": $scope.get('SiteStore').$sections()['$[]'](self.$params().$section()).$current_page()['$[]']("html")})}));
        return self.$convert_runable_code_blocks();
        } else {
        return nil
      }}, TMP_2.$$s = self, TMP_2.$$arity = 0, TMP_2), $a).call($c, $scope.get('DIV'));

    Opal.defn(self, '$convert_runable_code_blocks', TMP_4 = function $$convert_runable_code_blocks() {
      var $a, $b, TMP_3, self = this;

      return ($a = ($b = $scope.get('Element').$find("code.lang-ruby-runable")).$each, $a.$$p = (TMP_3 = function(mount_point){var self = TMP_3.$$s || this, code = nil;
if (mount_point == null) mount_point = nil;
      code = mount_point.$text();
        return $scope.get('React').$render($scope.get('React').$create_element($scope.get('CodeMirror'), $hash2(["code"], {"code": code})), mount_point.$parent());}, TMP_3.$$s = self, TMP_3.$$arity = 1, TMP_3), $a).call($b);
    }, TMP_4.$$arity = 0);

    return (Opal.defn(self, '$edit_button', TMP_12 = function $$edit_button() {
      var $a, $b, TMP_5, self = this;

      return ($a = ($b = $scope.get('Sem')).$Grid, $a.$$p = (TMP_5 = function(){var self = TMP_5.$$s || this, $c, $d, TMP_6;

      return ($c = ($d = $scope.get('Sem')).$GridColumn, $c.$$p = (TMP_6 = function(){var self = TMP_6.$$s || this, $e, $f, TMP_7, $g, TMP_10, $h, $i, TMP_11;

        if ((($e = self.$state().$needs_refresh()) !== nil && $e != null && (!$e.$$is_boolean || $e == true))) {
            return ($e = ($f = $scope.get('Sem')).$Message, $e.$$p = (TMP_7 = function(){var self = TMP_7.$$s || this, $g, $h, TMP_8, $i, TMP_9;

            ($g = ($h = $scope.get('Sem')).$MessageHeader, $g.$$p = (TMP_8 = function(){var self = TMP_8.$$s || this;

              return "Thank you!"}, TMP_8.$$s = self, TMP_8.$$arity = 0, TMP_8), $g).call($h);
              return ($g = ($i = self).$P, $g.$$p = (TMP_9 = function(){var self = TMP_9.$$s || this;

              return "PRs are always welcome."}, TMP_9.$$s = self, TMP_9.$$arity = 0, TMP_9), $g).call($i);}, TMP_7.$$s = self, TMP_7.$$arity = 0, TMP_7), $e).call($f, $hash2(["positive"], {"positive": true}))
            } else {
            return ($e = ($g = ($h = ($i = $scope.get('Sem')).$Button, $h.$$p = (TMP_11 = function(){var self = TMP_11.$$s || this;

            return nil}, TMP_11.$$s = self, TMP_11.$$arity = 0, TMP_11), $h).call($i, $hash2(["icon", "circular", "label"], {"icon": "github", "circular": true, "label": "Improve this page"}))).$on, $e.$$p = (TMP_10 = function(){var self = TMP_10.$$s || this;

            self.$mutate().$needs_refresh(true);
              return window.open($scope.get('SiteStore').$sections()['$[]'](self.$params().$section()).$current_page()['$[]']("edit_url"), "_blank");;}, TMP_10.$$s = self, TMP_10.$$arity = 0, TMP_10), $e).call($g, "click")
          }}, TMP_6.$$s = self, TMP_6.$$arity = 0, TMP_6), $c).call($d)}, TMP_5.$$s = self, TMP_5.$$arity = 0, TMP_5), $a).call($b, $hash2(["textAlign"], {"textAlign": "right"}));
    }, TMP_12.$$arity = 0), nil) && 'edit_button';
  })($scope.base, (($scope.get('Hyperloop')).$$scope.get('Component')))
};

/* Generated by Opal 0.10.5 */
Opal.modules["components/shared/page_toc"] = function(Opal) {
  function $rb_lt(lhs, rhs) {
    return (typeof(lhs) === 'number' && typeof(rhs) === 'number') ? lhs < rhs : lhs['$<'](rhs);
  }
  var self = Opal.top, $scope = Opal, nil = Opal.nil, $breaker = Opal.breaker, $slice = Opal.slice, $klass = Opal.klass, $hash2 = Opal.hash2;

  Opal.add_stubs(['$imports', '$param', '$render', '$Rail', '$ReactYahooSticky', '$DIV', '$loaded?', '$[]', '$sections', '$section', '$params', '$accordion', '$Accordion', '$each_with_index', '$on', '$animate', '$set_current_page', '$push', '$history', '$force_update!', '$AccordionTitle', '$I', '$B', '$AccordionContent', '$each', '$<', '$top', '$offset', '$A', '$==', '$drop', '$pages']);
  (function($base, $super) {
    ...
    return self.$imports("YahooSticky")
  })($scope.base, (($scope.get('Hyperloop')).$$scope.get('Component')));
  return (function($base, $super) {
    function $PageToc(){};
    ...
    return ($c = ($d = $scope.get('Sem')).$Rail, $c.$$p = (TMP_2 = function(){var self = TMP_2.$$s || this, $e, $f, TMP_3;
      ...
      return ($e = ($f = self).$ReactYahooSticky, $e.$$p = (TMP_3 = function(){var self = TMP_3.$$s || this, $g, $h, TMP_4;

        return ($g = ($h = self).$DIV, $g.$$p = (TMP_4 = function(){var self = TMP_4.$$s || this, $i;

          if ((($i = $scope.get('SiteStore').$sections()['$[]'](self.$params().$section())['$loaded?']()) !== nil && $i != null && (!$i.$$is_boolean || $i == true))) {
    ...
    return (Opal.defn(self, '$accordion', TMP_14 = function $$accordion() {
      ...
      return ($a = ($b = $scope.get('Sem')).$Accordion, $a.$$p = (TMP_5 = function(){var self = TMP_5.$$s || this, $c, $d, TMP_6;

      return ($c = ($d = $scope.get('SiteStore').$sections()['$[]'](self.$params().$section()).$pages()).$each_with_index, $c.$$p = (TMP_6 = function(page, index){var self = TMP_6.$$s || this, $e, $f, TMP_7, $g, $h, TMP_8, TMP_10;
if (page == null) page = nil;if (index == null) index = nil;
        ($e = ($f = ($g = ($h = $scope.get('Sem')).$AccordionTitle, $g.$$p = (TMP_8 = function(){var self = TMP_8.$$s || this, $i, $j, TMP_9;

          self.$I($hash2(["class"], {"class": "dropdown icon"}));
            return ($i = ($j = self).$B, $i.$$p = (TMP_9 = function(){var self = TMP_9.$$s || this;
          ...
          $scope.get('Element')['$[]']("html, body").$animate($hash2(["scrollTop"], {"scrollTop": 0}), "slow");
            $scope.get('SiteStore').$sections()['$[]'](self.$params().$section()).$set_current_page(page);
          ...
          return ($i = ($j = page['$[]']("headings").$drop(1)).$each, $i.$$p = (TMP_11 = function(heading){var self = TMP_11.$$s || this, $k, $l, TMP_12, $m, $n, TMP_13, $o;
if (heading == null) heading = nil;
            if ((($k = ($rb_lt(heading['$[]']("level"), 4))) !== nil && $k != null && (!$k.$$is_boolean || $k == true))) {
                return ($k = ($l = ($m = ($n = self).$A, $m.$$p = (TMP_13 = function(){var self = TMP_13.$$s || this;

                return heading['$[]']("text")}, TMP_13.$$s = self, TMP_13.$$arity = 0, TMP_13), $m).call($n, $hash2(["class"], {"class": "item " + ((function() {if ((($o = (heading['$[]']("level")['$=='](3))) !== nil && $o != null && (!$o.$$is_boolean || $o == true))) {
                  return "subitem"
                  } else {
                  return nil
                ...
                slug = "" + (heading['$[]']("slug"));
                  ...
                  $scope.get('Element')['$[]']("html, body").$animate($hash2(["scrollTop"], {"scrollTop": anchorchapter_position}), 500);
                  return self.$params().$history().$push("/" + (self.$params().$section()) + "/" + (page['$[]']("repo")) + "/" + (page['$[]']("file")) + "/" + (slug));}, TMP_12.$$s = self, TMP_12.$$arity = 0, TMP_12), $k).call($l, "click")
                } else {
                return nil
    ...
    }, TMP_14.$$arity = 0), nil) && 'accordion';
  })($scope.base, (($scope.get('Hyperloop')).$$scope.get('Component')));
};

/* Generated by Opal 0.10.5 */
Opal.modules["components/shared/code_mirror"] = function(Opal) {
  function $rb_minus(lhs, rhs) {
    return (typeof(lhs) === 'number' && typeof(rhs) === 'number') ? lhs - rhs : lhs['$-'](rhs);
  }
  var self = Opal.top, $scope = Opal, nil = Opal.nil, $breaker = Opal.breaker, $slice = Opal.slice, $klass = Opal.klass, $hash2 = Opal.hash2;

  Opal.add_stubs(['$imports', '$param', '$state', '$before_mount', '$code', '$mutate', '$params', '$render', '$Container', '$mirror', '$compile', '$evaluate', '$render_component', '$Message', '$PRE', '$compile_error', '$new', '$message', '$gsub', '$DIV', '$create_element', '$const_get', '$component_name', '$split', '$[]', '$-', '$index', '$ReactCodeMirror', '$to_n', '$lambda']);
  (function($base, $super) {
    ...
    return self.$imports("CodeMirror")
  })($scope.base, (($scope.get('Hyperloop')).$$scope.get('Component')));
  return (function($base, $super) {
    function $CodeMirror(){};
    var self = $CodeMirror = $klass($base, $super, 'CodeMirror', $CodeMirror);

    var def = self.$$proto, $scope = self.$$scope, $a, $b, TMP_1, $c, TMP_2, TMP_6, TMP_7, TMP_10, TMP_11, TMP_13;

    def.compiled_code = nil;
    self.$param("code");
    ...
    return self.$mutate().$code(self.$params().$code())}, TMP_1.$$s = self, TMP_1.$$arity = 0, TMP_1), $a).call($b);

    ($a = ($c = self).$render, $a.$$p = (TMP_2 = function(){var self = TMP_2.$$s || this, $d, $e, TMP_3;

    return ($d = ($e = $scope.get('Sem')).$Container, $d.$$p = (TMP_3 = function(){var self = TMP_3.$$s || this, $f, $g, $h, TMP_4;

      self.$mirror();
        if ((($f = ($g = ($h = self.$compile(), $h !== false && $h !== nil && $h != null ?self.$evaluate() : $h), $g !== false && $g !== nil && $g != null ?self.$render_component() : $g)) !== nil && $f != null && (!$f.$$is_boolean || $f == true))) {
          return nil
          } else {
          return ($f = ($g = $scope.get('Sem')).$Message, $f.$$p = (TMP_4 = function(){var self = TMP_4.$$s || this, $i, $j, TMP_5;

          return ($i = ($j = self).$PRE, $i.$$p = (TMP_5 = function(){var self = TMP_5.$$s || this;

            return self.$state().$compile_error()}, TMP_5.$$s = self, TMP_5.$$arity = 0, TMP_5), $i).call($j)}, TMP_4.$$s = self, TMP_4.$$arity = 0, TMP_4), $f).call($g, $hash2(["negative"], {"negative": true}))
        };}, TMP_3.$$s = self, TMP_3.$$arity = 0, TMP_3), $d).call($e)}, TMP_2.$$s = self, TMP_2.$$arity = 0, TMP_2), $a).call($c, $scope.get('DIV'));

    Opal.defn(self, '$compile', TMP_6 = function $$compile() {
      var self = this, ret = nil, e = nil, message = nil;

      try {
        ret = true;
        self.compiled_code = (($scope.get('Opal')).$$scope.get('Compiler')).$new(self.$state().$code()).$compile();
      } catch ($err) {
        if (Opal.rescue($err, [$scope.get('Exception')])) {e = $err;
          try {
            message = e.$message();
            self.$mutate().$compile_error(message.$gsub("An error occurred while compiling: (file)", "Oops..."));
            ret = false;
          } finally { Opal.pop_exception() }
        } else { throw $err; }
      };
    ...
    Opal.defn(self, '$evaluate', TMP_7 = function $$evaluate() {
      var self = this, ret = nil, e = nil;

      try {
        ret = true;
        eval(self.compiled_code);
      } catch ($err) {
        if (Opal.rescue($err, [$scope.get('Exception')])) {e = $err;
          try {
            self.$mutate().$compile_error("Oops... \n\n " + (e.$message()));
            ret = false;
          } finally { Opal.pop_exception() }
        } else { throw $err; }
      };
    ...
    Opal.defn(self, '$render_component', TMP_10 = function $$render_component() {
      var $a, $b, TMP_8, self = this, ret = nil, e = nil;

      try {
        ret = true;
        ($a = ($b = $scope.get('Sem')).$Message, $a.$$p = (TMP_8 = function(){var self = TMP_8.$$s || this, $c, $d, TMP_9;

        return ($c = ($d = self).$DIV, $c.$$p = (TMP_9 = function(){var self = TMP_9.$$s || this;

          return $scope.get('React').$create_element($scope.get('Module').$const_get(self.$component_name()), $hash2([], {}))}, TMP_9.$$s = self, TMP_9.$$arity = 0, TMP_9), $c).call($d, $hash2(["id"], {"id": "result"}))}, TMP_8.$$s = self, TMP_8.$$arity = 0, TMP_8), $a).call($b);
      } catch ($err) {
        if (Opal.rescue($err, [$scope.get('Exception')])) {e = $err;
          try {
            self.$mutate().$compile_error("React unhappy... \n\n " + (e.$message()));
            ret = false;
          } finally { Opal.pop_exception() }
        } else { throw $err; }
      };
    ...
    Opal.defn(self, '$component_name', TMP_11 = function $$component_name() {
      var self = this, elements = nil;

      elements = self.$state().$code().$split(" ");
      return elements['$[]'](($rb_minus(elements.$index("Hyperloop::Component"), 2)));
    }, TMP_11.$$arity = 0);

    return (Opal.defn(self, '$mirror', TMP_13 = function $$mirror() {
      var $a, $b, TMP_12, self = this, options = nil;
      ...
      return self.$ReactCodeMirror($hash2(["options", "value", "onChange"], {"options": options.$to_n(), "value": self.$state().$code(), "onChange": ($a = ($b = self).$lambda, $a.$$p = (TMP_12 = function(value){var self = TMP_12.$$s || this;
if (value == null) value = nil;
      return self.$mutate().$code(value)}, TMP_12.$$s = self, TMP_12.$$arity = 1, TMP_12), $a).call($b)}));
    }, TMP_13.$$arity = 0), nil) && 'mirror';
  })($scope.base, (($scope.get('Hyperloop')).$$scope.get('Component')));
};

/* Generated by Opal 0.10.5 */
Opal.modules["components/start/start_sidebar"] = function(Opal) {
  var self = Opal.top, $scope = Opal, nil = Opal.nil, $breaker = Opal.breaker, $slice = Opal.slice, $klass = Opal.klass, $hash2 = Opal.hash2;

  Opal.add_stubs(['$param', '$render', '$PageToc', '$section_store', '$params']);
  return (function($base, $super) {
    function $StartSidebar(){};
    var self = $StartSidebar = $klass($base, $super, 'StartSidebar', $StartSidebar);
    ...
    return self.$PageToc($hash2(["section_store"], {"section_store": self.$params().$section_store()}))}, TMP_1.$$s = self, TMP_1.$$arity = 0, TMP_1), $a).call($b, $scope.get('DIV'));
  })($scope.base, (($scope.get('Hyperloop')).$$scope.get('Component')))
};
...
Opal.modules["components/start/start_page"] = function(Opal) {
  ...
  return (function($base, $super) {
    ...
    sidebar = self.$DocsSidebar($hash2(["section_store", "history", "section"], {"section_store": $scope.get('SiteStore').$sections()['$[]']("start"), "history": self.$history(), "section": "start"})).$as_node();
      ...
      return self.$PageLayout($hash2(["sidebar_component", "body_component", "page_title", "section", "loaded"], {"sidebar_component": sidebar, "body_component": body, "page_title": title, "section": "start", "loaded": $scope.get('SiteStore').$sections()['$[]']("start")['$loaded?']()}));}, TMP_1.$$s = self, TMP_1.$$arity = 0, TMP_1), $a).call($b, $scope.get('DIV'))
  })($scope.base, (((($scope.get('Hyperloop')).$$scope.get('Router'))).$$scope.get('Component')))
};
...
/* Generated by Opal 0.10.5 */
Opal.modules["components/installation/installation_page"] = function(Opal) {
  var self = Opal.top, $scope = Opal, nil = Opal.nil, $breaker = Opal.breaker, $slice = Opal.slice, $klass = Opal.klass, $hash2 = Opal.hash2;

  Opal.add_stubs(['$render', '$as_node', '$InstallationSidebar', '$InstallationBody', '$PageLayout']);
  return (function($base, $super) {
    function $InstallationPage(){};
    var self = $InstallationPage = $klass($base, $super, 'InstallationPage', $InstallationPage);

    var def = self.$$proto, $scope = self.$$scope, $a, $b, TMP_1;

    return ($a = ($b = self).$render, $a.$$p = (TMP_1 = function(){var self = TMP_1.$$s || this, sidebar = nil, body = nil;

    sidebar = self.$InstallationSidebar().$as_node();
      body = self.$InstallationBody().$as_node();
      return self.$PageLayout($hash2(["sidebar_component", "body_component", "loaded"], {"sidebar_component": sidebar, "body_component": body, "loaded": true}));}, TMP_1.$$s = self, TMP_1.$$arity = 0, TMP_1), $a).call($b, $scope.get('DIV'))
  })($scope.base, (((($scope.get('Hyperloop')).$$scope.get('Router'))).$$scope.get('Component')))
};

/* Generated by Opal 0.10.5 */
Opal.modules["components/installation/installation_body"] = function(Opal) {
  var self = Opal.top, $scope = Opal, nil = Opal.nil, $breaker = Opal.breaker, $slice = Opal.slice, $klass = Opal.klass;

  Opal.add_stubs(['$render', '$H1']);
  return (function($base, $super) {
    function $InstallationBody(){};
    var self = $InstallationBody = $klass($base, $super, 'InstallationBody', $InstallationBody);
    ...
    return ($c = ($d = self).$H1, $c.$$p = (TMP_2 = function(){var self = TMP_2.$$s || this;
      ...
      return "Installation body"}, TMP_2.$$s = self, TMP_2.$$arity = 0, TMP_2), $c).call($d)}, TMP_1.$$s = self, TMP_1.$$arity = 0, TMP_1), $a).call($b, $scope.get('DIV'))
  })($scope.base, (($scope.get('Hyperloop')).$$scope.get('Component')))
};

/* Generated by Opal 0.10.5 */
Opal.modules["components/installation/installation_sidebar"] = function(Opal) {
  var self = Opal.top, $scope = Opal, nil = Opal.nil, $breaker = Opal.breaker, $slice = Opal.slice, $klass = Opal.klass;

  Opal.add_stubs(['$render', '$H1']);
  return (function($base, $super) {
    function $InstallationSidebar(){};
    var self = $InstallationSidebar = $klass($base, $super, 'InstallationSidebar', $InstallationSidebar);
    ...
    return ($c = ($d = self).$H1, $c.$$p = (TMP_2 = function(){var self = TMP_2.$$s || this;
      ...
      return "Installation sidebar"}, TMP_2.$$s = self, TMP_2.$$arity = 0, TMP_2), $c).call($d)}, TMP_1.$$s = self, TMP_1.$$arity = 0, TMP_1), $a).call($b, $scope.get('DIV'))
  })($scope.base, (($scope.get('Hyperloop')).$$scope.get('Component')))
};

/* Generated by Opal 0.10.5 */
Opal.modules["components/tools/tools_sidebar"] = function(Opal) {
  var self = Opal.top, $scope = Opal, nil = Opal.nil, $breaker = Opal.breaker, $slice = Opal.slice, $klass = Opal.klass;

  Opal.add_stubs(['$render', '$H1']);
  return (function($base, $super) {
    function $ToolsSidebar(){};
    var self = $ToolsSidebar = $klass($base, $super, 'ToolsSidebar', $ToolsSidebar);
    ...
    return ($c = ($d = self).$H1, $c.$$p = (TMP_2 = function(){var self = TMP_2.$$s || this;
      ...
      return "Tools sidebar"}, TMP_2.$$s = self, TMP_2.$$arity = 0, TMP_2), $c).call($d)}, TMP_1.$$s = self, TMP_1.$$arity = 0, TMP_1), $a).call($b, $scope.get('DIV'))
  })($scope.base, (($scope.get('Hyperloop')).$$scope.get('Component')))
};

/* Generated by Opal 0.10.5 */
Opal.modules["components/tools/tools_body"] = function(Opal) {
  var self = Opal.top, $scope = Opal, nil = Opal.nil, $breaker = Opal.breaker, $slice = Opal.slice, $klass = Opal.klass;

  Opal.add_stubs(['$render', '$H1']);
  return (function($base, $super) {
    function $ToolsBody(){};
    var self = $ToolsBody = $klass($base, $super, 'ToolsBody', $ToolsBody);
    ...
    return ($c = ($d = self).$H1, $c.$$p = (TMP_2 = function(){var self = TMP_2.$$s || this;
      ...
      return "Tools body"}, TMP_2.$$s = self, TMP_2.$$arity = 0, TMP_2), $c).call($d)}, TMP_1.$$s = self, TMP_1.$$arity = 0, TMP_1), $a).call($b, $scope.get('DIV'))
  })($scope.base, (($scope.get('Hyperloop')).$$scope.get('Component')))
};

/* Generated by Opal 0.10.5 */
Opal.modules["components/tools/tools_page"] = function(Opal) {
  var self = Opal.top, $scope = Opal, nil = Opal.nil, $breaker = Opal.breaker, $slice = Opal.slice, $klass = Opal.klass, $hash2 = Opal.hash2;

  Opal.add_stubs(['$render', '$DIV', '$A']);
  return (function($base, $super) {
    function $ToolsPage(){};
    var self = $ToolsPage = $klass($base, $super, 'ToolsPage', $ToolsPage);
    ...
    return ($c = ($d = self).$DIV, $c.$$p = (TMP_2 = function(){var self = TMP_2.$$s || this, $e, $f, TMP_3;
      ...
      return ($e = ($f = self).$DIV, $e.$$p = (TMP_3 = function(){var self = TMP_3.$$s || this, $g, $h, TMP_4, $i, TMP_5, $j, TMP_6, $k, TMP_7;

        ($g = ($h = self).$A, $g.$$p = (TMP_4 = function(){var self = TMP_4.$$s || this;

          return "link 1"}, TMP_4.$$s = self, TMP_4.$$arity = 0, TMP_4), $g).call($h, $hash2(["href"], {"href": ""}));
          ($g = ($i = self).$A, $g.$$p = (TMP_5 = function(){var self = TMP_5.$$s || this;

          return "link 1"}, TMP_5.$$s = self, TMP_5.$$arity = 0, TMP_5), $g).call($i, $hash2(["href"], {"href": ""}));
          ($g = ($j = self).$A, $g.$$p = (TMP_6 = function(){var self = TMP_6.$$s || this;

          return "link 1"}, TMP_6.$$s = self, TMP_6.$$arity = 0, TMP_6), $g).call($j, $hash2(["href"], {"href": ""}));
          return ($g = ($k = self).$A, $g.$$p = (TMP_7 = function(){var self = TMP_7.$$s || this;

          return "link 1"}, TMP_7.$$s = self, TMP_7.$$arity = 0, TMP_7), $g).call($k, $hash2(["href"], {"href": ""}));}, TMP_3.$$s = self, TMP_3.$$arity = 0, TMP_3), $e).call($f, $hash2(["class"], {"class": "fixedmenu"}))}, TMP_2.$$s = self, TMP_2.$$arity = 0, TMP_2), $c).call($d, $hash2(["class"], {"class": "testdiv"}))}, TMP_1.$$s = self, TMP_1.$$arity = 0, TMP_1), $a).call($b, $scope.get('DIV'))
  })($scope.base, (((($scope.get('Hyperloop')).$$scope.get('Router'))).$$scope.get('Component')))
};
...
Opal.modules["components/old/page"] = function(Opal) {
  ...
  return (function($base, $super) {
    ...
    self.$puts("before mount");
      return self.$get_page();}, TMP_1.$$s = self, TMP_1.$$arity = 0, TMP_1), $a).call($b);

    ($a = ($c = self).$render, $a.$$p = (TMP_2 = function(){var self = TMP_2.$$s || this;

    return nil}, TMP_2.$$s = self, TMP_2.$$arity = 0, TMP_2), $a).call($c, $scope.get('DIV'));

    Opal.defn(self, '$get_page', TMP_3 = function $$get_page() {
      var self = this;

      return nil;
    }, TMP_3.$$arity = 0);

    Opal.defn(self, '$runable', TMP_5 = function $$runable() {
      var $a, $b, TMP_4, self = this;
...
if (mount_point == null) mount_point = nil;
    ...
    Opal.defn(self, '$search_input', TMP_7 = function $$search_input() {
      var $a, $b, TMP_6, self = this;

      return ($a = ($b = $scope.get('Sem').$Input($hash2(["placeholder", "fluid"], {"placeholder": "Search", "fluid": true}))).$on, $a.$$p = (TMP_6 = function(e){var self = TMP_6.$$s || this;
if (e == null) e = nil;
      return self.$mutate().$search(e.$target().$value())}, TMP_6.$$s = self, TMP_6.$$arity = 1, TMP_6), $a).call($b, "change");
    }, TMP_7.$$arity = 0);

    Opal.defn(self, '$side_nav', TMP_12 = function $$side_nav() {
      var $a, $b, TMP_8, self = this;

      return ($a = ($b = $scope.get('Sem')).$Container, $a.$$p = (TMP_8 = function(){var self = TMP_8.$$s || this, $c, $d, TMP_9;

      return ($c = ($d = self).$Sticky, $c.$$p = (TMP_9 = function(){var self = TMP_9.$$s || this, $e, $f, TMP_10, $g, TMP_11;

        self.$search_input();
          ($e = ($f = self).$H4, $e.$$p = (TMP_10 = function(){var self = TMP_10.$$s || this;

          return "Sections"}, TMP_10.$$s = self, TMP_10.$$arity = 0, TMP_10), $e).call($f);
          self.$sections_results();
          if (self.$state().$search()['$==']("")) {
            } else {
            ($e = ($g = self).$H4, $e.$$p = (TMP_11 = function(){var self = TMP_11.$$s || this;

            return "Code"}, TMP_11.$$s = self, TMP_11.$$arity = 0, TMP_11), $e).call($g)
          };
          return self.$code_results();}, TMP_9.$$s = self, TMP_9.$$arity = 0, TMP_9), $c).call($d)}, TMP_8.$$s = self, TMP_8.$$arity = 0, TMP_8), $a).call($b, $hash2(["style"], {"style": $hash2(["marginTop", "paddingLeft"], {"marginTop": "2em", "paddingLeft": "28px"})}));
    }, TMP_12.$$arity = 0);

    Opal.defn(self, '$sections_results', TMP_16 = function $$sections_results() {
      var $a, $b, TMP_13, self = this;

      if ((($a = self.$state().$headings()) !== nil && $a != null && (!$a.$$is_boolean || $a == true))) {
        return ($a = ($b = self.$state().$headings()).$each, $a.$$p = (TMP_13 = function(heading){var self = TMP_13.$$s || this, $c, $d, TMP_14, $e, TMP_15;
if (heading == null) heading = nil;
        if ((($c = self.$state().$search()) !== nil && $c != null && (!$c.$$is_boolean || $c == true))) {
            if ((($c = heading['$[]']("text").$downcase()['$include?'](self.$state().$search().$downcase())) !== nil && $c != null && (!$c.$$is_boolean || $c == true))) {
              return ($c = ($d = self).$P, $c.$$p = (TMP_14 = function(){var self = TMP_14.$$s || this;

              return heading['$[]']("text")}, TMP_14.$$s = self, TMP_14.$$arity = 0, TMP_14), $c).call($d)
              } else {
              return nil
            }
            } else {
            return ($c = ($e = self).$P, $c.$$p = (TMP_15 = function(){var self = TMP_15.$$s || this;

            return heading['$[]']("text")}, TMP_15.$$s = self, TMP_15.$$arity = 0, TMP_15), $c).call($e)
    ...
    return (Opal.defn(self, '$code_results', TMP_19 = function $$code_results() {
      var $a, $b, TMP_17, self = this;

      if ((($a = ($b = self.$state().$code_blocks(), $b !== false && $b !== nil && $b != null ?self.$state().$search() : $b)) !== nil && $a != null && (!$a.$$is_boolean || $a == true))) {
        return ($a = ($b = self.$state().$code_blocks()).$each, $a.$$p = (TMP_17 = function(code){var self = TMP_17.$$s || this, $c, $d, TMP_18;
if (code == null) code = nil;
        if ((($c = ($d = self.$state().$search()['$!='](""), $d !== false && $d !== nil && $d != null ?code['$[]']("code").$downcase()['$include?'](self.$state().$search().$downcase()) : $d)) !== nil && $c != null && (!$c.$$is_boolean || $c == true))) {
            return ($c = ($d = self).$PRE, $c.$$p = (TMP_18 = function(){var self = TMP_18.$$s || this;

            return self.$DIV($hash2(["dangerously_set_inner_HTML"], {"dangerously_set_inner_HTML": $hash2(["__html"], {"__html": code['$[]']("html")})}))}, TMP_18.$$s = self, TMP_18.$$arity = 0, TMP_18), $c).call($d, $hash2(["class"], {"class": "hljs"}))
            } else {
            return nil
    ...
    }, TMP_19.$$arity = 0), nil) && 'code_results';
  })($scope.base, (($scope.get('Hyperloop')).$$scope.get('Component')))
};

/* Generated by Opal 0.10.5 */
Opal.modules["components/old/site_menu"] = function(Opal) {
  var self = Opal.top, $scope = Opal, nil = Opal.nil, $breaker = Opal.breaker, $slice = Opal.slice;
...
/* Generated by Opal 0.10.5 */
Opal.modules["components/old/pages_toc"] = function(Opal) {
  var self = Opal.top, $scope = Opal, nil = Opal.nil, $breaker = Opal.breaker, $slice = Opal.slice, $klass = Opal.klass;

  Opal.add_stubs(['$param', '$before_mount', '$render']);
  return (function($base, $super) {
    function $PagesToc(){};
    ...
    return ($a = ($c = self).$render, $a.$$p = (TMP_2 = function(){var self = TMP_2.$$s || this;
...
/* Generated by Opal 0.10.5 */
Opal.modules["components/tutorials/tutorials_body"] = function(Opal) {
  var self = Opal.top, $scope = Opal, nil = Opal.nil, $breaker = Opal.breaker, $slice = Opal.slice, $klass = Opal.klass;

  Opal.add_stubs(['$render', '$H1']);
  return (function($base, $super) {
    function $TutorialsBody(){};
    var self = $TutorialsBody = $klass($base, $super, 'TutorialsBody', $TutorialsBody);
    ...
    return ($c = ($d = self).$H1, $c.$$p = (TMP_2 = function(){var self = TMP_2.$$s || this;
      ...
      return "Tutorials body"}, TMP_2.$$s = self, TMP_2.$$arity = 0, TMP_2), $c).call($d)}, TMP_1.$$s = self, TMP_1.$$arity = 0, TMP_1), $a).call($b, $scope.get('DIV'))
  })($scope.base, (($scope.get('Hyperloop')).$$scope.get('Component')))
};

/* Generated by Opal 0.10.5 */
Opal.modules["components/tutorials/totorials_page"] = function(Opal) {
  var self = Opal.top, $scope = Opal, nil = Opal.nil, $breaker = Opal.breaker, $slice = Opal.slice, $klass = Opal.klass, $hash2 = Opal.hash2;

  Opal.add_stubs(['$render', '$as_node', '$TutorialsSidebar', '$TutorialsBody', '$PageLayout']);
  return (function($base, $super) {
    function $TutorialsPage(){};
    var self = $TutorialsPage = $klass($base, $super, 'TutorialsPage', $TutorialsPage);

    var def = self.$$proto, $scope = self.$$scope, $a, $b, TMP_1;

    return ($a = ($b = self).$render, $a.$$p = (TMP_1 = function(){var self = TMP_1.$$s || this, sidebar = nil, body = nil;

    sidebar = self.$TutorialsSidebar().$as_node();
      body = self.$TutorialsBody().$as_node();
      return self.$PageLayout($hash2(["sidebar_component", "body_component", "loaded"], {"sidebar_component": sidebar, "body_component": body, "loaded": true}));}, TMP_1.$$s = self, TMP_1.$$arity = 0, TMP_1), $a).call($b, $scope.get('DIV'))
  })($scope.base, (((($scope.get('Hyperloop')).$$scope.get('Router'))).$$scope.get('Component')))
};

/* Generated by Opal 0.10.5 */
Opal.modules["components/tutorials/tutorials_sidebar"] = function(Opal) {
  var self = Opal.top, $scope = Opal, nil = Opal.nil, $breaker = Opal.breaker, $slice = Opal.slice, $klass = Opal.klass;

  Opal.add_stubs(['$render', '$H1']);
  return (function($base, $super) {
    function $TutorialsSidebar(){};
    var self = $TutorialsSidebar = $klass($base, $super, 'TutorialsSidebar', $TutorialsSidebar);
    ...
    return ($c = ($d = self).$H1, $c.$$p = (TMP_2 = function(){var self = TMP_2.$$s || this;
      ...
      return "Tutorials sidebar"}, TMP_2.$$s = self, TMP_2.$$arity = 0, TMP_2), $c).call($d)}, TMP_1.$$s = self, TMP_1.$$arity = 0, TMP_1), $a).call($b, $scope.get('DIV'))
  })($scope.base, (($scope.get('Hyperloop')).$$scope.get('Component')))
};

/* Generated by Opal 0.10.5 */
Opal.modules["stores/search_engine_store"] = function(Opal) {
  function $rb_plus(lhs, rhs) {
    return (typeof(lhs) === 'number' && typeof(rhs) === 'number') ? lhs + rhs : lhs['$+'](rhs);
  }
  function $rb_gt(lhs, rhs) {
  ...
  Opal.add_stubs(['$state', '$[]=', '$pages', '$[]', '$sections', '$each', '$concat', '$match_content', '$inputvalue', '$==', '$size', '$<<', '$to_s', '$allresults', '$mutate', '$private', '$new', '$+', '$downcase', '$excerpt', '$!', '$nil?', '$fetch', '$split', '$delete', '$>', '$max', '$-', '$length', '$drop', '$first', '$join', '$===', '$escape', '$match', '$empty?', '$cut_excerpt_part', '$strip']);
  return (function($base, $super) {
    function $SearchEngineStore(){};
    var self = $SearchEngineStore = $klass($base, $super, 'SearchEngineStore', $SearchEngineStore);

    var def = self.$$proto, $scope = self.$$scope;

    return (function(self) {
      var $scope = self.$$scope, def = self.$$proto, TMP_2, TMP_3, TMP_4, TMP_6;

      self.$state($hash2(["inputvalue", "scope", "reader"], {"inputvalue": "", "scope": "shared", "reader": true}));
      self.$state($hash2(["inputvaluetoosmall", "scope", "reader"], {"inputvaluetoosmall": "", "scope": "shared", "reader": true}));
      self.$state($hash2(["allresults", "scope", "reader"], {"allresults": [], "scope": "shared", "reader": true}));
      Opal.defn(self, '$search_content', TMP_2 = function $$search_content(sectionname) {
        var $a, $b, TMP_1, self = this, data = nil, a = nil, pages = nil;

        data = [];
        a = $hash2([], {});
        a['$[]=']("name", sectionname);
        a['$[]=']("results", []);
        pages = $scope.get('SiteStore').$sections()['$[]'](sectionname).$pages();
        ($a = ($b = pages).$each, $a.$$p = (TMP_1 = function(page){var self = TMP_1.$$s || this;
if (page == null) page = nil;
        return a['$[]']("results").$concat(self.$match_content(self.$state().$inputvalue(), page))}, TMP_1.$$s = self, TMP_1.$$arity = 1, TMP_1), $a).call($b);
        if (a['$[]']("results").$size()['$=='](0)) {
          } else {
          data['$<<'](a)
        };
        a['$[]=']("result_number", a['$[]']("results").$size().$to_s());
        return self.$mutate().$allresults(data);
      }, TMP_2.$$arity = 1);
      self.$private();
      Opal.defn(self, '$match_content', TMP_3 = function $$match_content(value, page) {
        var $a, $b, self = this, ret = nil, result_item = nil, keyindex = nil, search_regex = nil, content = nil, search_content_result = nil, content_part = nil;

        ret = [];
        result_item = $hash2([], {});
        keyindex = 0;
        search_regex = $scope.get('Regexp').$new($rb_plus($rb_plus("(\\W|^)", value.$downcase()), "(\\W|$)"));
        content = page['$[]']("body");
        search_content_result = self.$excerpt(content.$downcase(), search_regex, $hash2(["radius"], {"radius": 30}));
        while ((($b = search_content_result['$nil?']()['$!']()) !== nil && $b != null && (!$b.$$is_boolean || $b == true))) {
        ...
        result_item['$[]=']("key", "" + (result_item['$[]']("repo")) + "-" + (result_item['$[]']("file")) + "-" + (keyindex = $rb_plus(keyindex, 1)));
        ret['$<<'](result_item);
        content_part = search_content_result['$[]']("sliced_content");
        search_content_result = self.$excerpt(content_part, search_regex, $hash2(["radius"], {"radius": 30}));
        result_item = $hash2([], {});};
        return ret;
      }, TMP_3.$$arity = 2);
      Opal.defn(self, '$cut_excerpt_part', TMP_4 = function $$cut_excerpt_part(part_position, part, separator, options) {
        var $a, self = this, radius = nil, omission = nil, affix = nil, drop_index = nil;
        ...
        part.$delete("");
        affix = (function() {if ((($a = $rb_gt(part.$size(), radius)) !== nil && $a != null && (!$a.$$is_boolean || $a == true))) {
          return omission
          } else {
          return ""
        }; return nil; })();
        part = (function() {if (part_position['$==']("first")) {
          drop_index = [$rb_minus(part.$length(), radius), 0].$max();
          return part.$drop(drop_index);
          } else {
          return part.$first(radius)
        }; return nil; })();
        return [affix, part.$join(separator)];
      }, TMP_4.$$arity = 4);
      return (Opal.defn(self, '$excerpt', TMP_6 = function $$excerpt(text, phrase, options) {
        var $a, $b, TMP_5, $c, self = this, excerptarray = nil, separator = nil, $case = nil, regex = nil, matches = nil, first_part = nil, second_part = nil, prefix = nil, postfix = nil, affix = nil;

        if (options == null) {
          options = $hash2([], {});
        }
        excerptarray = $hash2([], {});
        if ((($a = (($b = text !== false && text !== nil && text != null) ? phrase : text)) !== nil && $a != null && (!$a.$$is_boolean || $a == true))) {
          } else {
          return nil
        };
        separator = ((($a = options.$fetch("separator", nil)) !== false && $a !== nil && $a != null) ? $a : "");
        $case = phrase;if ($scope.get('Regexp')['$===']($case)) {regex = phrase}else {regex = (new RegExp("" + $scope.get('Regexp').$escape(phrase)))};
        if ((($a = matches = text.$match(regex)) !== nil && $a != null && (!$a.$$is_boolean || $a == true))) {
          } else {
          return nil
        };
        phrase = matches['$[]'](0);
        if ((($a = separator['$empty?']()) !== nil && $a != null && (!$a.$$is_boolean || $a == true))) {
          } else {
          (function(){var $brk = Opal.new_brk(); try {return ($a = ($b = text.$split(separator)).$each, $a.$$p = (TMP_5 = function(value){var self = TMP_5.$$s || this, $c;
if (value == null) value = nil;
          if ((($c = value.$match(regex)) !== nil && $c != null && (!$c.$$is_boolean || $c == true))) {
              regex = phrase = value;
        ...
        $c = text.$split(phrase, 2), $a = Opal.to_ary($c), first_part = ($a[0] == null ? nil : $a[0]), second_part = ($a[1] == null ? nil : $a[1]), $c;
        excerptarray['$[]=']("sliced_content", second_part);
        $c = self.$cut_excerpt_part("first", first_part, separator, options), $a = Opal.to_ary($c), prefix = ($a[0] == null ? nil : $a[0]), first_part = ($a[1] == null ? nil : $a[1]), $c;
        $c = self.$cut_excerpt_part("second", second_part, separator, options), $a = Opal.to_ary($c), postfix = ($a[0] == null ? nil : $a[0]), second_part = ($a[1] == null ? nil : $a[1]), $c;
        affix = [first_part, separator, phrase, separator, second_part].$join().$strip();
        excerptarray['$[]=']("result_item_text", [prefix, affix, postfix].$join());
        return excerptarray;
      }, TMP_6.$$arity = -3), nil) && 'excerpt';
    })(Opal.get_singleton_class(self))
  })($scope.base, (($scope.get('Hyperloop')).$$scope.get('Store')))
};

/* Generated by Opal 0.10.5 */
Opal.modules["stores/sidebar_store"] = function(Opal) {
  var self = Opal.top, $scope = Opal, nil = Opal.nil, $breaker = Opal.breaker, $slice = Opal.slice, $klass = Opal.klass, $hash2 = Opal.hash2;

  Opal.add_stubs(['$state', '$visible', '$mutate', '$!']);
  return (function($base, $super) {
    function $SidebarStore(){};
    var self = $SidebarStore = $klass($base, $super, 'SidebarStore', $SidebarStore);
    ...
    return (function(self) {
      ...
      self.$state($hash2(["visible", "scope", "reader"], {"visible": false, "scope": "shared", "reader": true}));
      Opal.defn(self, '$hide', TMP_1 = function $$hide() {
        var self = this;

        return self.$mutate().$visible(false);
      }, TMP_1.$$arity = 0);
      return (Opal.defn(self, '$toggle', TMP_2 = function $$toggle() {
        var self = this;

        return self.$mutate().$visible(self.$state().$visible()['$!']());
      }, TMP_2.$$arity = 0), nil) && 'toggle';
    })(Opal.get_singleton_class(self))
  })($scope.base, (($scope.get('Hyperloop')).$$scope.get('Store')))
};

/* Generated by Opal 0.10.5 */
Opal.modules["stores/search_result_modal_store"] = function(Opal) {
  var self = Opal.top, $scope = Opal, nil = Opal.nil, $breaker = Opal.breaker, $slice = Opal.slice, $klass = Opal.klass, $hash2 = Opal.hash2;

  Opal.add_stubs(['$state', '$visible', '$mutate', '$inputvaluetoosmall', '$!']);
  return (function($base, $super) {
    function $SearchResultModalStore(){};
    var self = $SearchResultModalStore = $klass($base, $super, 'SearchResultModalStore', $SearchResultModalStore);
    ...
    return (function(self) {
      ...
      Opal.defn(self, '$hide', TMP_1 = function $$hide() {
        ...
        self.$mutate().$visible(false);
        return $scope.get('SearchEngineStore').$mutate().$inputvaluetoosmall("");
      }, TMP_1.$$arity = 0);
      Opal.defn(self, '$show', TMP_2 = function $$show() {
        var self = this;

        return self.$mutate().$visible(true);
      }, TMP_2.$$arity = 0);
      return (Opal.defn(self, '$toggle', TMP_3 = function $$toggle() {
        var self = this;

        return self.$mutate().$visible(self.$state().$visible()['$!']());
      }, TMP_3.$$arity = 0), nil) && 'toggle';
    })(Opal.get_singleton_class(self))
  })($scope.base, (($scope.get('Hyperloop')).$$scope.get('Store')))
};

/* Generated by Opal 0.10.5 */
Opal.modules["stores/section_store"] = function(Opal) {
  function $rb_plus(lhs, rhs) {
    return (typeof(lhs) === 'number' && typeof(rhs) === 'number') ? lhs + rhs : lhs['$+'](rhs);
  }
  function $rb_minus(lhs, rhs) {
  ...
  Opal.add_stubs(['$state', '$puts', '$load_and_convert_pages', '$current_page', '$mutate', '$[]', '$loaded', '$current_anchor', '$private', '$each', '$get', '$+', '$ok?', '$new', '$body', '$[]=', '$headings', '$code_blocks', '$html', '$gsub', '$edit_url', '$alert', '$raw_url', '$-', '$==']);
  return (function($base, $super) {
    ...
    Opal.defn(self, '$initialize', TMP_1 = function $$initialize(pages) {
      var self = this;

      self.$puts("SectionStore is starting now");
      self.pages = pages;
      self.$load_and_convert_pages();
      return self.$mutate().$current_page(self.pages['$[]'](0));
    }, TMP_1.$$arity = 1);

    Opal.defn(self, '$pages', TMP_2 = function $$pages() {
      var self = this;

      return self.pages;
    }, TMP_2.$$arity = 0);

    Opal.defn(self, '$loaded?', TMP_3 = function() {
      var self = this;

      return self.$state().$loaded();
    }, TMP_3.$$arity = 0);

    Opal.defn(self, '$current_page', TMP_4 = function $$current_page() {
      var self = this;

      return self.$state().$current_page();
    }, TMP_4.$$arity = 0);

    Opal.defn(self, '$current_anchor', TMP_5 = function $$current_anchor() {
      var self = this;

      return self.$state().$current_anchor();
    }, TMP_5.$$arity = 0);

    Opal.defn(self, '$set_current_page', TMP_6 = function $$set_current_page(page) {
      var self = this;

      return self.$mutate().$current_page(page);
    }, TMP_6.$$arity = 1);

    Opal.defn(self, '$set_current_anchor', TMP_7 = function $$set_current_anchor(anchor) {
      var self = this;
...
if (response == null) response = nil;
      if ((($c = response['$ok?']()) !== nil && $c != null && (!$c.$$is_boolean || $c == true))) {
        ...
        self.promises = $rb_minus(self.promises, 1);
        if (self.promises['$=='](0)) {
...
Opal.modules["stores/site_store"] = function(Opal) {
  ...
  Opal.add_stubs(['$receives', '$init', '$each', '$loaded?', '$[]', '$private', '$load_start_section', '$load_docs_section', '$[]=', '$new']);
  return (function($base, $super) {
    function $SiteStore(){};
    ...
    return (function(self) {
      var $scope = self.$$scope, def = self.$$proto, TMP_2, TMP_4, TMP_5, TMP_6, TMP_7;
      ...
      Opal.defn(self, '$loaded?', TMP_4 = function() {
        var $a, $b, TMP_3, self = this, ret = nil;
        if (self.section_stores == null) self.section_stores = nil;

        ret = true;
        ($a = ($b = self.section_stores).$each, $a.$$p = (TMP_3 = function(section){var self = TMP_3.$$s || this, $c;
if (section == null) section = nil;
        if ((($c = section['$[]'](1)['$loaded?']()) !== nil && $c != null && (!$c.$$is_boolean || $c == true))) {
            return nil
            } else {
            return ret = false
      ...
      self.$private();
      Opal.defn(self, '$init', TMP_5 = function $$init() {
        var self = this;
      ...
      Opal.defn(self, '$load_start_section', TMP_6 = function $$load_start_section() {
        var self = this, pages = nil;
        if (self.section_stores == null) self.section_stores = nil;

        pages = [$hash2(["id", "repo", "file", "allow_edit"], {"id": 1, "repo": "hyperloop-website", "file": "pages/start/components.md", "allow_edit": true}), $hash2(["id", "repo", "file", "allow_edit"], {"id": 2, "repo": "hyperloop-website", "file": "pages/start/stores.md", "allow_edit": true}), $hash2(["id", "repo", "file", "allow_edit"], {"id": 3, "repo": "hyperloop-website", "file": "pages/start/models.md", "allow_edit": true}), $hash2(["id", "repo", "file", "allow_edit"], {"id": 4, "repo": "hyperloop-website", "file": "pages/start/operations.md", "allow_edit": true}), $hash2(["id", "repo", "file", "allow_edit"], {"id": 5, "repo": "hyperloop-website", "file": "pages/start/policies.md", "allow_edit": true}), $hash2(["id", "repo", "file", "allow_edit"], {"id": 6, "repo": "hyperloop-website", "file": "pages/start/pradgmatic.md", "allow_edit": true})];
        return self.section_stores['$[]=']("start", $scope.get('SectionStore').$new(pages));
      }, TMP_6.$$arity = 0);
      return (Opal.defn(self, '$load_docs_section', TMP_7 = function $$load_docs_section() {
        var self = this, pages = nil;
        if (self.section_stores == null) self.section_stores = nil;

        pages = [$hash2(["id", "repo", "file", "allow_edit"], {"id": 1, "repo": "hyperloop-website", "file": "dist/dummy_DOCS.md", "allow_edit": true}), $hash2(["id", "repo", "file", "allow_edit"], {"id": 2, "repo": "hyper-react", "file": "DOCS.md", "allow_edit": true}), $hash2(["id", "repo", "file", "allow_edit"], {"id": 3, "repo": "hyper-store", "file": "DOCS.md", "allow_edit": true}), $hash2(["id", "repo", "file", "allow_edit"], {"id": 4, "repo": "hyper-router", "file": "DOCS.md", "allow_edit": true}), $hash2(["id", "repo", "file", "allow_edit"], {"id": 5, "repo": "hyper-mesh", "file": "DOCS.md", "allow_edit": true}), $hash2(["id", "repo", "file", "allow_edit"], {"id": 6, "repo": "hyper-operation", "file": "DOCS.md", "allow_edit": true}), $hash2(["id", "repo", "file", "allow_edit"], {"id": 7, "repo": "hyper-operation", "file": "DOCS-POLICIES.md", "allow_edit": true})];
        return self.section_stores['$[]=']("docs", $scope.get('SectionStore').$new(pages));
      }, TMP_7.$$arity = 0), nil) && 'load_docs_section';
    })(Opal.get_singleton_class(self));
  })($scope.base, (($scope.get('Hyperloop')).$$scope.get('Store')))
};
...
(function(Opal) {
  ...
  Opal.add_stubs(['$require_tree', '$require', '$listen', '$ready?', '$render', '$AppRouter', '$[]']);
  self.$require_tree("components");
  self.$require_tree("stores");
  self.$require("opal_hot_reloader");
  $scope.get('OpalHotReloader').$listen(25222, false, 1);
  return ($a = ($b = $scope.get('Document'))['$ready?'], $a.$$p = (TMP_1 = function(){var self = TMP_1.$$s || this, $c, $d, TMP_2;

  return ($c = ($d = $scope.get('Element')['$[]']("#hyperloopsite")).$render, $c.$$p = (TMP_2 = function(){var self = TMP_2.$$s || this;

    return self.$AppRouter()}, TMP_2.$$s = self, TMP_2.$$arity = 0, TMP_2), $c).call($d)}, TMP_1.$$s = self, TMP_1.$$arity = 0, TMP_1), $a).call($b);
})(Opal);
