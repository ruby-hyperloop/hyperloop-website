...
Opal.modules["components/docs/docs_sidebar"] = function(Opal) {
  ...
  Opal.add_stubs(['$param', '$render', '$Segment', '$Header', '$PageToc', '$section_store', '$params']);
  return (function($base, $super) {
    ...
    ($c = ($d = $scope.get('Sem')).$Segment, $c.$$p = (TMP_2 = function(){var self = TMP_2.$$s || this, $e, $f, TMP_3;

      return ($e = ($f = $scope.get('Sem')).$Header, $e.$$p = (TMP_3 = function(){var self = TMP_3.$$s || this;

        return "COMPS Documentation"}, TMP_3.$$s = self, TMP_3.$$arity = 0, TMP_3), $e).call($f, $hash2(["as"], {"as": "h3"}))}, TMP_2.$$s = self, TMP_2.$$arity = 0, TMP_2), $c).call($d, $hash2(["basic"], {"basic": true}));
...
Opal.modules["components/home/home_body"] = function(Opal) {
  ...
  Opal.add_stubs(['$render', '$H1', '$FormRadio', '$==', '$active_item', '$state', '$lambda', '$mutate', '$P', '$to_s', '$on', '$first_name', '$value', '$target', '$Input']);
  return (function($base, $super) {
    function $HomeBody(){};
    var self = $HomeBody = $klass($base, $super, 'HomeBody', $HomeBody);

    var def = self.$$proto, $scope = self.$$scope, $a, $b, TMP_1;

    return ($a = ($b = self).$render, $a.$$p = (TMP_1 = function(){var self = TMP_1.$$s || this, $c, $d, TMP_2, $e, TMP_3, $f, TMP_4, $g, TMP_5, $h, TMP_6, $i, TMP_7, $j, TMP_8;

    ($c = ($d = self).$H1, $c.$$p = (TMP_2 = function(){var self = TMP_2.$$s || this;

      return "Home body"}, TMP_2.$$s = self, TMP_2.$$arity = 0, TMP_2), $c).call($d);
      $scope.get('Sem').$FormRadio($hash2(["label", "checked", "onChange"], {"label": "Small", "checked": (self.$state().$active_item()['$==']("sm")), "onChange": ($c = ($e = self).$lambda, $c.$$p = (TMP_3 = function(){var self = TMP_3.$$s || this;

      return self.$mutate().$active_item("sm")}, TMP_3.$$s = self, TMP_3.$$arity = 0, TMP_3), $c).call($e)}));
      $scope.get('Sem').$FormRadio($hash2(["label", "checked", "onChange"], {"label": "Medium", "checked": (self.$state().$active_item()['$==']("md")), "onChange": ($c = ($f = self).$lambda, $c.$$p = (TMP_4 = function(){var self = TMP_4.$$s || this;

      return self.$mutate().$active_item("md")}, TMP_4.$$s = self, TMP_4.$$arity = 0, TMP_4), $c).call($f)}));
      $scope.get('Sem').$FormRadio($hash2(["label", "checked", "onChange"], {"label": "Large", "checked": (self.$state().$active_item()['$==']("lg")), "onChange": ($c = ($g = self).$lambda, $c.$$p = (TMP_5 = function(){var self = TMP_5.$$s || this;

      return self.$mutate().$active_item("lg")}, TMP_5.$$s = self, TMP_5.$$arity = 0, TMP_5), $c).call($g)}));
      ($c = ($h = self).$P, $c.$$p = (TMP_6 = function(){var self = TMP_6.$$s || this;

      return "The selected one is " + (self.$state().$active_item().$to_s())}, TMP_6.$$s = self, TMP_6.$$arity = 0, TMP_6), $c).call($h);
      ($c = ($i = $scope.get('Sem').$Input($hash2(["label", "placeholder"], {"label": "First name", "placeholder": "First name please"}))).$on, $c.$$p = (TMP_7 = function(e){var self = TMP_7.$$s || this;
if (e == null) e = nil;
      return self.$mutate().$first_name(e.$target().$value())}, TMP_7.$$s = self, TMP_7.$$arity = 1, TMP_7), $c).call($i, "change");
      return ($c = ($j = self).$P, $c.$$p = (TMP_8 = function(){var self = TMP_8.$$s || this;

      return "Your first name is " + (self.$state().$first_name())}, TMP_8.$$s = self, TMP_8.$$arity = 0, TMP_8), $c).call($j);}, TMP_1.$$s = self, TMP_1.$$arity = 0, TMP_1), $a).call($b, $scope.get('DIV'))
  })($scope.base, (($scope.get('Hyperloop')).$$scope.get('Component')))
};
...
Opal.modules["components/home/home_page"] = function(Opal) {
  ...
  Opal.add_stubs(['$render', '$as_node', '$HomeSidebar', '$HomeBody', '$PageLayout']);
  return (function($base, $super) {
    function $HomePage(){};
    ...
    sidebar = self.$HomeSidebar().$as_node();
      body = self.$HomeBody().$as_node();
      return self.$PageLayout($hash2(["sidebar_component", "body_component", "loaded"], {"sidebar_component": sidebar, "body_component": body, "loaded": true}));}, TMP_1.$$s = self, TMP_1.$$arity = 0, TMP_1), $a).call($b, $scope.get('DIV'))
  })($scope.base, (((($scope.get('Hyperloop')).$$scope.get('Router'))).$$scope.get('Component')))
};
...
Opal.modules["components/home/home_sidebar"] = function(Opal) {
  ...
  return (function($base, $super) {
    ...
    var self = $HomeSidebar = $klass($base, $super, 'HomeSidebar', $HomeSidebar);
    ...
    return ($c = ($d = self).$H1, $c.$$p = (TMP_2 = function(){var self = TMP_2.$$s || this;
      ...
      return "Home sidebar"}, TMP_2.$$s = self, TMP_2.$$arity = 0, TMP_2), $c).call($d)}, TMP_1.$$s = self, TMP_1.$$arity = 0, TMP_1), $a).call($b, $scope.get('DIV'))
  })($scope.base, (($scope.get('Hyperloop')).$$scope.get('Component')))
};
...
Opal.modules["components/shared/page_layout"] = function(Opal) {
  ...
  Opal.add_stubs(['$param', '$render', '$Dimmer', '$Loader', '$loaded', '$params', '$Grid', '$GridRow', '$AppMenu', '$GridColumn', '$SidebarPushable', '$Sidebar', '$Container', '$sidebar_component', '$visible', '$SidebarPusher', '$body_component']);
  return (function($base, $super) {
    function $PageLayout(){};
    ...
    return ($a = ($b = self).$render, $a.$$p = (TMP_1 = function(){var self = TMP_1.$$s || this, $c, $d, TMP_2, $e, TMP_3;

    ($c = ($d = $scope.get('Sem')).$Dimmer, $c.$$p = (TMP_2 = function(){var self = TMP_2.$$s || this;

      return $scope.get('Sem').$Loader($hash2(["inverted", "size", "content"], {"inverted": true, "size": "large", "content": "Loading dynamic content..."}))}, TMP_2.$$s = self, TMP_2.$$arity = 0, TMP_2), $c).call($d, $hash2(["active", "inverted"], {"active": ((function() {if ((($e = self.$params().$loaded()) !== nil && $e != null && (!$e.$$is_boolean || $e == true))) {
        return false
        } else {
        return true
      }; return nil; })()), "inverted": true}));
      return ($c = ($e = $scope.get('Sem')).$Grid, $c.$$p = (TMP_3 = function(){var self = TMP_3.$$s || this, $f, $g, TMP_4, $h, TMP_5;

      ($f = ($g = $scope.get('Sem')).$GridRow, $f.$$p = (TMP_4 = function(){var self = TMP_4.$$s || this;

        return self.$AppMenu()}, TMP_4.$$s = self, TMP_4.$$arity = 0, TMP_4), $f).call($g);
        return ($f = ($h = $scope.get('Sem')).$GridRow, $f.$$p = (TMP_5 = function(){var self = TMP_5.$$s || this, $i, $j, TMP_6, $k, TMP_10;

        ($i = ($j = $scope.get('Sem')).$GridColumn, $i.$$p = (TMP_6 = function(){var self = TMP_6.$$s || this, $k, $l, TMP_7;

          return ($k = ($l = $scope.get('Sem')).$SidebarPushable, $k.$$p = (TMP_7 = function(){var self = TMP_7.$$s || this, $m, $n, TMP_8;

            return ($m = ($n = $scope.get('Sem')).$Sidebar, $m.$$p = (TMP_8 = function(){var self = TMP_8.$$s || this, $o, $p, TMP_9;

              return ($o = ($p = $scope.get('Sem')).$Container, $o.$$p = (TMP_9 = function(){var self = TMP_9.$$s || this;

                return self.$params().$sidebar_component().$render()}, TMP_9.$$s = self, TMP_9.$$arity = 0, TMP_9), $o).call($p, $hash2(["style"], {"style": $hash2(["marginTop"], {"marginTop": "3.5em"})}))}, TMP_8.$$s = self, TMP_8.$$arity = 0, TMP_8), $m).call($n, $hash2(["animation", "width", "visible"], {"animation": "push", "width": "wide", "visible": $scope.get('SidebarStore').$visible()}))}, TMP_7.$$s = self, TMP_7.$$arity = 0, TMP_7), $k).call($l)}, TMP_6.$$s = self, TMP_6.$$arity = 0, TMP_6), $i).call($j);
          return ($i = ($k = $scope.get('Sem')).$GridColumn, $i.$$p = (TMP_10 = function(){var self = TMP_10.$$s || this, $l, $m, TMP_11;

          return ($l = ($m = $scope.get('Sem')).$SidebarPusher, $l.$$p = (TMP_11 = function(){var self = TMP_11.$$s || this, $n, $o, TMP_12;

            return ($n = ($o = $scope.get('Sem')).$Container, $n.$$p = (TMP_12 = function(){var self = TMP_12.$$s || this;

              return self.$params().$body_component().$render()}, TMP_12.$$s = self, TMP_12.$$arity = 0, TMP_12), $n).call($o, $hash2(["text", "style"], {"text": true, "style": $hash2(["marginTop"], {"marginTop": "3.5em"})}))}, TMP_11.$$s = self, TMP_11.$$arity = 0, TMP_11), $l).call($m)}, TMP_10.$$s = self, TMP_10.$$arity = 0, TMP_10), $i).call($k);}, TMP_5.$$s = self, TMP_5.$$arity = 0, TMP_5), $f).call($h, $hash2(["columns"], {"columns": "3"}));}, TMP_3.$$s = self, TMP_3.$$arity = 0, TMP_3), $c).call($e);}, TMP_1.$$s = self, TMP_1.$$arity = 0, TMP_1), $a).call($b, $scope.get('DIV'));
  })($scope.base, (((($scope.get('Hyperloop')).$$scope.get('Router'))).$$scope.get('Component')))
};
...
Opal.modules["components/shared/page_toc"] = function(Opal) {
  ...
  Opal.add_stubs(['$param', '$render', '$loaded?', '$section_store', '$params', '$DIV', '$accordion', '$each_with_index', '$<<', '$as_node', '$toc_heading', '$[]', '$panel', '$to_s', '$pages', '$Accordion', '$to_n', '$UL', '$each', '$toc_item', '$drop', '$on', '$set_current_page', '$force_update!', '$SPAN', '$LI', '$A']);
  return (function($base, $super) {
    function $PageToc(){};
    var self = $PageToc = $klass($base, $super, 'PageToc', $PageToc);

    var def = self.$$proto, $scope = self.$$scope, $a, $b, TMP_1, TMP_4, TMP_7, TMP_10, TMP_14;

    self.$param("section_store");

    ($a = ($b = self).$render, $a.$$p = (TMP_1 = function(){var self = TMP_1.$$s || this, $c, $d, TMP_2;

    if ((($c = self.$params().$section_store()['$loaded?']()) !== nil && $c != null && (!$c.$$is_boolean || $c == true))) {
        return ($c = ($d = self).$DIV, $c.$$p = (TMP_2 = function(){var self = TMP_2.$$s || this;

        return self.$accordion()}, TMP_2.$$s = self, TMP_2.$$arity = 0, TMP_2), $c).call($d, $hash2(["class"], {"class": "accordian-div"}))
        } else {
        return nil
      }}, TMP_1.$$s = self, TMP_1.$$arity = 0, TMP_1), $a).call($b);

    Opal.defn(self, '$accordion', TMP_4 = function $$accordion() {
      var $a, $b, TMP_3, self = this, panels = nil;

      panels = [];
      ($a = ($b = self.$params().$section_store().$pages()).$each_with_index, $a.$$p = (TMP_3 = function(page, index){var self = TMP_3.$$s || this;
if (page == null) page = nil;if (index == null) index = nil;
      return panels['$<<']($hash2(["title", "content", "key"], {"title": self.$toc_heading(page, page['$[]']("headings")['$[]'](0)).$as_node(), "content": self.$panel(page).$as_node(), "key": index.$to_s()}))}, TMP_3.$$s = self, TMP_3.$$arity = 2, TMP_3), $a).call($b);
      return $scope.get('Sem').$Accordion($hash2(["panels", "styled", "fluid"], {"panels": panels.$to_n(), "styled": true, "fluid": true}));
    }, TMP_4.$$arity = 0);

    Opal.defn(self, '$panel', TMP_7 = function $$panel(page) {
      var $a, $b, TMP_5, self = this;

      return ($a = ($b = self).$UL, $a.$$p = (TMP_5 = function(){var self = TMP_5.$$s || this, $c, $d, TMP_6;

      return ($c = ($d = page['$[]']("headings").$drop(1)).$each, $c.$$p = (TMP_6 = function(heading){var self = TMP_6.$$s || this;
if (heading == null) heading = nil;
        return self.$toc_item(page, heading)}, TMP_6.$$s = self, TMP_6.$$arity = 1, TMP_6), $c).call($d)}, TMP_5.$$s = self, TMP_5.$$arity = 0, TMP_5), $a).call($b);
    }, TMP_7.$$arity = 1);

    Opal.defn(self, '$toc_heading', TMP_10 = function $$toc_heading(page, heading) {
      var $a, $b, TMP_8, $c, $d, TMP_9, self = this;

      return ($a = ($b = ($c = ($d = self).$SPAN, $c.$$p = (TMP_9 = function(){var self = TMP_9.$$s || this;

      return heading['$[]']("text")}, TMP_9.$$s = self, TMP_9.$$arity = 0, TMP_9), $c).call($d, $hash2(["class"], {"class": "header"}))).$on, $a.$$p = (TMP_8 = function(){var self = TMP_8.$$s || this;

      self.$params().$section_store().$set_current_page(page);
        return self['$force_update!']();}, TMP_8.$$s = self, TMP_8.$$arity = 0, TMP_8), $a).call($b, "click");
    }, TMP_10.$$arity = 2);

    return (Opal.defn(self, '$toc_item', TMP_14 = function $$toc_item(page, heading) {
      var $a, $b, TMP_11, self = this;

      return ($a = ($b = self).$LI, $a.$$p = (TMP_11 = function(){var self = TMP_11.$$s || this, $c, $d, TMP_12, $e, $f, TMP_13;

      return ($c = ($d = ($e = ($f = self).$A, $e.$$p = (TMP_13 = function(){var self = TMP_13.$$s || this;

        return "" + (heading['$[]']("text"))}, TMP_13.$$s = self, TMP_13.$$arity = 0, TMP_13), $e).call($f)).$on, $c.$$p = (TMP_12 = function(){var self = TMP_12.$$s || this;

        self.$params().$section_store().$set_current_page(page);
          return self['$force_update!']();}, TMP_12.$$s = self, TMP_12.$$arity = 0, TMP_12), $c).call($d, "click")}, TMP_11.$$s = self, TMP_11.$$arity = 0, TMP_11), $a).call($b, $hash2(["class"], {"class": "toc_h" + (heading['$[]']("level"))}));
    }, TMP_14.$$arity = 2), nil) && 'toc_item';
  })($scope.base, (($scope.get('Hyperloop')).$$scope.get('Component')))
};
  ...
  return (function($base, $super) {
    ...
    ($c = ($d = $scope.get('Sem')).$Segment, $c.$$p = (TMP_2 = function(){var self = TMP_2.$$s || this, $e, $f, TMP_3;
      ...
      return ($e = ($f = $scope.get('Sem')).$Header, $e.$$p = (TMP_3 = function(){var self = TMP_3.$$s || this;
        ...
        return "Start learning Hyperloop"}, TMP_3.$$s = self, TMP_3.$$arity = 0, TMP_3), $e).call($f, $hash2(["as"], {"as": "h3"}))}, TMP_2.$$s = self, TMP_2.$$arity = 0, TMP_2), $c).call($d, $hash2(["basic"], {"basic": true}));
      return self.$PageToc($hash2(["section_store"], {"section_store": self.$params().$section_store()}));}, TMP_1.$$s = self, TMP_1.$$arity = 0, TMP_1), $a).call($b, $scope.get('DIV'));
  })($scope.base, (($scope.get('Hyperloop')).$$scope.get('Component')))
};
...
Opal.modules["components/tools/tools_page"] = function(Opal) {
  ...
  Opal.add_stubs(['$render', '$as_node', '$ToolsSidebar', '$ToolsBody', '$PageLayout']);
  return (function($base, $super) {
    function $ToolsPage(){};
    ...
    sidebar = self.$ToolsSidebar().$as_node();
      body = self.$ToolsBody().$as_node();
      return self.$PageLayout($hash2(["sidebar_component", "body_component", "loaded"], {"sidebar_component": sidebar, "body_component": body, "loaded": true}));}, TMP_1.$$s = self, TMP_1.$$arity = 0, TMP_1), $a).call($b, $scope.get('DIV'))
  })($scope.base, (((($scope.get('Hyperloop')).$$scope.get('Router'))).$$scope.get('Component')))
};
...
Opal.modules["stores/sidebar_store"] = function(Opal) {
  ...
  return (function($base, $super) {
    ...
    return (function(self) {
      ...
      self.$state($hash2(["visible", "scope", "reader"], {"visible": true, "scope": "shared", "reader": true}));
      return (Opal.defn(self, '$toggle', TMP_1 = function $$toggle() {
        var self = this;
