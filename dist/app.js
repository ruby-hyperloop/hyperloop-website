...
Opal.modules["components/home"] = function(Opal) {
  ...
  Opal.add_stubs(['$render', '$Grid', '$GridRow', '$GridColumn', '$side_nav', '$body', '$Container', '$Sticky', '$DIV', '$times', '$SPAN', '$Page']);
  return (function($base) {
    ...
    (function($base, $super) {
      ...
      var def = self.$$proto, $scope = self.$$scope, $a, $b, TMP_1, TMP_11, TMP_13;
      ...
      Opal.defn(self, '$side_nav', TMP_11 = function $$side_nav() {
        ...
        return ($c = ($d = self).$Sticky, $c.$$p = (TMP_7 = function(){var self = TMP_7.$$s || this, $e, $f, TMP_8;
          ...
          return ($e = ($f = self).$DIV, $e.$$p = (TMP_8 = function(){var self = TMP_8.$$s || this, $g, $h, TMP_9;
            ...
            return ($g = ($h = (500)).$times, $g.$$p = (TMP_9 = function(){var self = TMP_9.$$s || this, $i, $j, TMP_10;
      ...
      return (Opal.defn(self, '$body', TMP_13 = function $$body() {
        ...
        return ($a = ($b = $scope.get('Sem')).$Container, $a.$$p = (TMP_12 = function(){var self = TMP_12.$$s || this;

        return self.$Page()}, TMP_12.$$s = self, TMP_12.$$arity = 0, TMP_12), $a).call($b, $hash2(["style"], {"style": $hash2(["marginTop", "paddingRight"], {"marginTop": "2em", "paddingRight": "28px"})}));
...
Opal.modules["components/page"] = function(Opal) {
  ...
  Opal.add_stubs(['$after_mount', '$puts', '$render', '$on', '$get', '$body', '$html', '$mutate', '$Marked', '$BUTTON', '$DIV', '$state']);
  return (function($base, $super) {
    function $Page(){};
    ...
    return self.$puts("about to get")}, TMP_1.$$s = self, TMP_1.$$arity = 0, TMP_1), $a).call($b);

    return ($a = ($c = self).$render, $a.$$p = (TMP_2 = function(){var self = TMP_2.$$s || this, $d, $e, TMP_3, $f, $g, TMP_5;

    ($d = ($e = ($f = ($g = self).$BUTTON, $f.$$p = (TMP_5 = function(){var self = TMP_5.$$s || this;

      return "do it"}, TMP_5.$$s = self, TMP_5.$$arity = 0, TMP_5), $f).call($g)).$on, $d.$$p = (TMP_3 = function(){var self = TMP_3.$$s || this, $f, $g, TMP_4;

      return ($f = ($g = $scope.get('HTTP')).$get, $f.$$p = (TMP_4 = function(response){var self = TMP_4.$$s || this;
          if (self.raw == null) self.raw = nil;
if (response == null) response = nil;
        self.raw = response.$body();
          return self.$mutate().$html(self.$Marked(self.raw));}, TMP_4.$$s = self, TMP_4.$$arity = 1, TMP_4), $f).call($g, "https://raw.githubusercontent.com/ruby-hyperloop/hyper-react/master/DOCS.md")}, TMP_3.$$s = self, TMP_3.$$arity = 0, TMP_3), $d).call($e, "click");
      return self.$DIV($hash2(["dangerously_set_inner_HTML"], {"dangerously_set_inner_HTML": $hash2(["__html"], {"__html": self.$state().$html()})}));}, TMP_2.$$s = self, TMP_2.$$arity = 0, TMP_2), $a).call($c, $scope.get('DIV'));
  })($scope.base, (($scope.get('Hyperloop')).$$scope.get('Component')))
};
