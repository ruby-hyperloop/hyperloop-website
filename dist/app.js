  ...
  return (function($base) {
    ...
    (function($base, $super) {
      ...
      ($c = ($d = self).$H1, $c.$$p = (TMP_2 = function(){var self = TMP_2.$$s || this;
        ...
        return "Hello I am the new Hyperloop website"}, TMP_2.$$s = self, TMP_2.$$arity = 0, TMP_2), $c).call($d);
        ...
        return self.$alert("V3 baby")}, TMP_3.$$s = self, TMP_3.$$arity = 0, TMP_3), $c).call($e, "click");}, TMP_1.$$s = self, TMP_1.$$arity = 0, TMP_1), $a).call($b, $scope.get('DIV'))
