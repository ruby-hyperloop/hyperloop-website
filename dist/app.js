...
Opal.modules["components/page"] = function(Opal) {
  ...
  Opal.add_stubs(['$before_mount', '$puts', '$get', '$html', '$mutate', '$body', '$render', '$SPAN', '$state']);
  return (function($base, $super) {
    function $Page(){};
    ...
    self.$puts("about to get");
      return ($c = ($d = $scope.get('HTTP')).$get, $c.$$p = (TMP_2 = function(response){var self = TMP_2.$$s || this;
if (response == null) response = nil;
      return self.$mutate().$html(response.$body())}, TMP_2.$$s = self, TMP_2.$$arity = 1, TMP_2), $c).call($d, "https://raw.githubusercontent.com/ruby-hyperloop/hyper-react/master/DOCS.md");}, TMP_1.$$s = self, TMP_1.$$arity = 0, TMP_1), $a).call($b);

    return ($a = ($c = self).$render, $a.$$p = (TMP_3 = function(){var self = TMP_3.$$s || this, $d, $e, TMP_4;

    return ($d = ($e = self).$SPAN, $d.$$p = (TMP_4 = function(){var self = TMP_4.$$s || this;

      return self.$state().$html()}, TMP_4.$$s = self, TMP_4.$$arity = 0, TMP_4), $d).call($e)}, TMP_3.$$s = self, TMP_3.$$arity = 0, TMP_3), $a).call($c, $scope.get('DIV'));
  })($scope.base, (($scope.get('Hyperloop')).$$scope.get('Component')))
};
