...
Opal.modules["components/page"] = function(Opal) {
  ...
  Opal.add_stubs(['$before_mount', '$puts', '$get', '$body', '$html', '$mutate', '$render', '$Highlight', '$state']);
  return (function($base, $super) {
    function $Page(){};
...
if (response == null) response = nil;
    ...
    return ($d = ($e = self).$Highlight, $d.$$p = (TMP_4 = function(){var self = TMP_4.$$s || this;
